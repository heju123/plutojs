...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"test1View","1":"movementView"}[chunkId]||chunkId) + ".chunk.js";
...
var Rect = /** @class */ (function (_super) {
    ...
    Rect.prototype.initCfg = function (cfg) {
        var promise = _super.prototype.initCfg.call(this, cfg);
        return promise;
    };
    Rect.prototype.draw = function (ctx) {
        var _this = this;
        if (!_super.prototype.draw.call(this, ctx)) {
            return false;
        }
        ctx.save();
        ...
        if (this.currentBackgroundImage && this.currentBackgroundImage.dom) {
            ...
            if (this.currentBackgroundImage.clip) {
                ctx.drawImage(this.currentBackgroundImage.dom, this.currentBackgroundImage.clip[0], this.currentBackgroundImage.clip[1], this.currentBackgroundImage.clip[2], this.currentBackgroundImage.clip[3], this.getRealX(), this.getRealY(), this.getWidth(), this.getHeight());
            }
            else {
        ...
        if (this.text && this.text.length > 0) {
            var Input_1 = __webpack_require__(2).default;
            ctx.save();
            this.setClip(ctx);
            ctx.beginPath();
            ...
            this.text.forEach(function (row, index) {
                if (_this instanceof Input_1) {
                    char_1 = undefined;
                    cindex_1 = 0;
                    while (char_1 = row.charAt(cindex_1)) {
                        ctx.fillText(char_1, _this.getTextRealX() + cindex_1 * parseInt(_this.style.fontSize, 10), _this.getTextRealY() + _this.style.lineHeight / 2 - parseInt(_this.style.fontSize, 10) / 2 + _this.style.lineHeight * index);
                        cindex_1++;
                    }
                }
                else {
                    ctx.fillText(row, _this.getTextRealX(), _this.getTextRealY() + _this.style.lineHeight / 2 - parseInt(_this.style.fontSize, 10) / 2 + _this.style.lineHeight * index);
                }
            });
            ctx.closePath();
            ctx.restore();
    ...
    /** 设置后避免超出当前组件范围 */
    Rect.prototype.setClip = function (ctx) {
        ctx.beginPath();
    ...
    Rect.prototype.getRectRadiusPath = function (arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
     ...
     */
    Rect.prototype.getRectRadiusPath_self = function (self, ctx, radius, padding) {
     ...
     * @param padding 整体扩大的像素
     */
    Rect.prototype.getRectRadiusPath_xywh = function (px, py, pwidth, pheight, ctx, radius, padding) {
        padding = padding || 0;
        var x = px - padding;
        var y = py - padding;
     ...
     */
    Rect.prototype.inParentArea = function (com) {
        return 1;
        // if (!com.parent)
        // {
        //     return -1;
     ...
     * @return true：在范围内
     */
    Rect.prototype.isPointInComponent = function (ctx, px, py) {
        ctx.save();
        ctx.beginPath();
        if (this.needTranslateOriginOfCoor2Center()) {
            this.setOriginalCoor2Center(ctx);
        ...
        var ret = ctx.isPointInPath(px, py);
        ctx.closePath();
        ctx.restore();
        return ret;
    };
...
var globalUtil_1 = __webpack_require__(1);
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.initCfg = function (cfg) {
        var promise = _super.prototype.initCfg.call(this, cfg);
        return promise;
    };
    Input.prototype.draw = function (ctx) {
        ...
        ctx.beginPath();
        //focus
        if (globalUtil_1.default.action.focusComponent === this && !this.style.readOnly) {
            //绘制光标
    ...
    /** 获取文本输入光标位置 */
    Input.prototype.getTextCursorPos = function () {
        var selectionEnd = globalUtil_1.default.action.inputListenerDom.selectionEnd;
        var textRow;
        if (this.text && this.text.length > 0) {
    ...
    Input.prototype.drawTextCursor = function (ctx) {
        if (this.showTextCursor) {
            if (!globalUtil_1.default.action.inputListenerDom.compositionMode) {
    ...
    Input.prototype.onFocus = function (mx, my) {
        var _this = this;
        _super.prototype.onFocus.call(this, mx, my);
        this.showTextCursorInterval = 0;
        this.showTextCursor = true;
        globalUtil_1.default.action.inputListenerDom.value = this.getText() || "";
        if (this.text) {
            var textX_1;
            var textY_1;
            var charCount_1 = 0;
            ...
            this.text.forEach(function (row, index) {
                ...
                cindex_1 = 0;
                while (char_1 = row.charAt(cindex_1)) {
                    textX_1 = _this.getTextRealX() + cindex_1 * parseInt(_this.style.fontSize, 10);
                    textY_1 = _this.getTextRealY() + _this.style.lineHeight / 2 - parseInt(_this.style.fontSize, 10) / 2 + _this.style.lineHeight * index;
                    if (my >= textY_1
                        && my <= textY_1 + parseInt(_this.style.fontSize, 10)
                        && mx >= textX_1
                        && mx <= textX_1 + parseInt(_this.style.fontSize, 10)) {
                        globalUtil_1.default.action.inputListenerDom.setSelectionRange(charCount_1 + 1, charCount_1 + 1);
                    }
                    charCount_1++;
                    cindex_1++;
                }
    ...
    Input.prototype.getTextRealX = function () {
        return _super.prototype.getTextRealX.call(this);
    };
    Input.prototype.getTextRealY = function () {
        var oriY = _super.prototype.getTextRealY.call(this);
...
var Event = /** @class */ (function () {
    ...
    Event.prototype.setCurrentTarget = function (target) {
        this.currentTarget = target; //绑定事件对象
    };
    //设置浏览器事件对象
    Event.prototype.setSourceEvent = function (event) {
 ...
 */
var fps_1 = __webpack_require__(22);
var httpUtil_1 = __webpack_require__(16);
exports.httpUtil = httpUtil_1.default;
var commonUtil_1 = __webpack_require__(5);
exports.commonUtil = commonUtil_1.default;
var globalUtil_1 = __webpack_require__(1);
var thread_1 = __webpack_require__(18);
exports.Thread = thread_1.default;
var controller_1 = __webpack_require__(19);
exports.Controller = controller_1.default;
var promise_1 = __webpack_require__(6);
exports.MPromise = promise_1.default;
var animationUtil_1 = __webpack_require__(10);
exports.animationUtil = animationUtil_1.default;
var component_1 = __webpack_require__(7);
...
var checkbox_1 = __webpack_require__(15);
...
var Main = /** @class */ (function () {
    function Main(eleId) {
        ...
        this.fps = new fps_1.default(mainBody);
        globalUtil_1.default.action = {};
        //输入框输入监听
        globalUtil_1.default.action.inputListenerDom = document.createElement("TEXTAREA");
        globalUtil_1.default.action.inputListenerDom.style.position = "fixed";
        globalUtil_1.default.action.inputListenerDom.style.left = "0px";
        globalUtil_1.default.action.inputListenerDom.style.top = "0px";
        globalUtil_1.default.action.inputListenerDom.style.opacity = 0;
        globalUtil_1.default.action.inputListenerDom.style["z-index"] = -1;
        document.body.appendChild(globalUtil_1.default.action.inputListenerDom);
        //屏蔽鼠标右键菜单
        mainBody.oncontextmenu = function (e) {
            e.preventDefault();
        };
    }
    Main.prototype.setMainView = function (viewCfg) {
        this.fps.setMainView(viewCfg);
        this.fps.startLoop();
    };
    Main.prototype.run = function (viewCfg) {
...
var commonUtil = {
    ...
    asyncLoadScript: function (url, callback) {
        var $this = commonUtil;
        if ($this.asyncLoadedScripts[url] != undefined) {
            if (callback && typeof (callback) == "function") {
                if ($this.asyncLoadedScripts[url] == 0) {
    ...
    concatList: function (list, addList) {
     ...
     * @return 复制的目标对象
     */
    copyObject: function (obj, dest, override, deep) {
     ...
     * @return 复制的目标对象
     */
    copyArray: function (obj, dest, deep) {
        var result = dest || [];
     ...
     * @return 数组信息
     */
    getArrayInfoByKey: function (arr, key, value) {
        var item;
    ...
    /** 根据后缀获取时间(单位：秒) */
    getTimeSecForSuffix: function (time) {
     ...
     */
    removeExtraAttr: function (obj, compareObj, ignoreAttrs) {
        for (var key in obj) {
     ...
     * @param msg
     */
    popMessageTooltip: function (msg, opts) {
        alert(msg);
    },
    /**
     * 创建图片dom
     */
    createImageDom: function (url) {
...
var MPromise = /** @class */ (function () {
    function MPromise() {
        ...
        this.promise = new Promise(function (resolve, reject) {
            _this.resolveObj = resolve;
            _this.rejectObj = reject;
        });
    }
    MPromise.prototype.resolve = function (data) {
        this.resolveObj(data);
    };
    MPromise.prototype.reject = function (err) {
        this.rejectObj(err);
    };
    MPromise.prototype.then = function (resolve, reject) {
        ...
        this.promise.then(function (data) {
            resolve(data);
            if (_this.finallyResolve && typeof (_this.finallyResolve) === "function") {
                _this.finallyResolve();
            }
        }, function (err) {
            reject(err);
            if (_this.finallyResolve && typeof (_this.finallyResolve) === "function") {
    ...
    MPromise.prototype.finally = function (resolve) {
...
var Component = /** @class */ (function () {
    function Component(parent) {
        this.parent = parent;
        this.viewState = globalUtil_1.default.viewState;
        this.isInit = false;
    ...
    Component.prototype.init = function () {
        ...
        if (this.style.backgroundImages && this.style.backgroundImages.length > 0) {
            ...
            allPromise.push(new Promise(function (resolve) {
                _this.initBackgroundImageDom(_this.currentBackgroundImage.url).then(function (imgDom) {
                    _this.currentBackgroundImage.dom = imgDom;
                    resolve();
                });
            }));
        }
        this.afterInitPromise = new Promise(function (resolve) {
    ...
    Component.prototype.initBackgroundImageDom = function (url) {
        var $this = this;
        return new Promise(function (resolve, reject) {
            commonUtil_1.default.createImageDom(url).then(function (imgThis) {
    ...
    Component.prototype.initBackgroundImages = function (backgroundImages) {
        var _this = this;
        var bgImages = backgroundImages || this.style.backgroundImages;
        var allPromise = [];
        if (this.style.backgroundImage) {
            allPromise.push(new Promise(function (resolve) {
                _this.initBackgroundImageDom(_this.style.backgroundImage).then(function (imgDom) {
                    bgImages.forEach(function (bgi) {
                        bgi.dom = imgDom;
                    });
                    resolve();
                });
            ...
            bgImages.forEach(function (bgi) {
                allPromise.push(new Promise(function (resolve) {
                    _this.initBackgroundImageDom(bgi.url).then(function (imgDom) {
                        bgi.dom = imgDom;
                        resolve();
                    });
                }));
    ...
    //背景图片轮询播放
    Component.prototype.onChangeBgImageInterval = function () {
    ...
    Component.prototype.createBackgroundImagesIntervalObj = function (interval) {
    ...
    Component.prototype.removeBackgroundImagesIntervalObj = function () {
        if (this.backgroundImagesIntervalObj) {
            window.clearInterval(this.backgroundImagesIntervalObj);
        }
    };
    /** 配置文件递归初始化样式 */
    Component.prototype.initCfgStyle = function (cfgStyle) {
     ...
     * @param cfg
     */
    Component.prototype.initCfg = function (cfg) {
        var allPromise = [];
        if (cfg.id) {
            this.id = cfg.id;
        }
    ...
    Component.prototype.initChildrenCfg = function (childrenCfg) {
        var allPromise = [];
    ...
    Component.prototype.newComByType = function (type) {
        var Router = __webpack_require__(13).default;
        var Rect = __webpack_require__(0).default;
        var Input = __webpack_require__(2).default;
        var Button = __webpack_require__(14).default;
        var Checkbox = __webpack_require__(15).default;
        var Scrollbar = __webpack_require__(8).default;
        var Map = __webpack_require__(9).default;
    ...
    Component.prototype.produceChildrenByCfg = function (chiCfg) {
        var _this = this;
        var childCom;
        if (typeof (chiCfg) === "function") {
            return chiCfg(this.asyncGetView.bind(this));
        }
        else {
            return new Promise(function (resolve) {
                childCom = _this.newComByType(chiCfg.type);
                childCom.initCfg(chiCfg).then(function () {
                    resolve(childCom);
                });
                _this.appendChildren(childCom);
                childCom.parent = _this;
            });
        }
    };
    Component.prototype.asyncGetView = function (viewCfg, resolve, reject) {
        var childCom = this.newComByType(viewCfg.type);
        childCom.initCfg(viewCfg).then(function () {
            if (resolve) {
                resolve(childCom);
            }
        });
    ...
    Component.prototype.setDefaultStyle = function () {
        if (this.style.fontFamily === undefined) {
            this.setStyle("fontFamily", globalUtil_1.default.viewState.defaultFontFamily);
        }
        if (this.style.fontSize === undefined) {
            this.setStyle("fontSize", globalUtil_1.default.viewState.defaultFontSize);
        }
        if (this.style.fontColor === undefined) {
            this.setStyle("fontColor", globalUtil_1.default.viewState.defaultFontColor);
        }
        if (this.style.zIndex === undefined) {
            this.setStyle("zIndex", 1);
        }
        if (this.style.multiLine === undefined) {
            this.setStyle("multiLine", true);
        }
        if (this.style.autoLine === undefined) {
            this.setStyle("autoLine", true);
        }
        if (this.style.scale === undefined) {
            this.style.scale = "1,1";
        }
        if (this.style.rotate === undefined) {
            this.style.rotate = 0;
        }
    };
    ...
    /** 添加子节点 */
    Component.prototype.appendChildren = function (child) {
        var _this = this;
        this.children.push(child);
        this.isSort = false;
        child.afterInitPromise.then(function () {
            _this.propagationDoLayout(_this);
        });
    };
    /** 设置通用样式，所有组件在绘制前都应该设置 */
    Component.prototype.setCommonStyle = function (ctx) {
    ...
    /** 设置ctx的scale */
    Component.prototype.setScaleEnable = function (ctx) {
        var scale = this.style.scale;
        if (scale !== undefined && scale !== "1,1") {
            var mirror = this.style.mirror;
            if (mirror !== undefined) {
                return;
            }
    ...
    /** 设置ctx的rotate */
    Component.prototype.setRotateEnable = function (ctx) {
        var rotate = this.style.rotate;
        if (rotate !== undefined && rotate !== 0) {
            ctx.rotate(rotate * Math.PI / 180);
        }
    };
    /** 设置镜像 */
    Component.prototype.setMirrorEnable = function (ctx) {
        var mirror = this.style.mirror;
        if (mirror !== undefined) {
            var scale = this.style.scale;
            var scaleArr = [1, 1];
    ...
    /** 将坐标原点设置到组件中心 */
    Component.prototype.setOriginalCoor2Center = function (ctx) {
        var transX = this.getRealXRecursion(this) + this.getWidth() / 2;
        var transY = this.getRealYRecursion(this) + this.getHeight() / 2;
        ctx.translate(transX, transY);
    };
    /** 将坐标原点从组件中心还原到0,0 */
    Component.prototype.restoreOriginalCoor2Zero = function (ctx) {
        var transX = this.getRealXRecursion(this) + this.getWidth() / 2;
        var transY = this.getRealYRecursion(this) + this.getHeight() / 2;
        ctx.translate(-transX, -transY);
    };
    /** 将样式恢复成original */
    Component.prototype.restoreStyle2Original = function () {
        this.copyStyle(this.originalStyle);
        //删掉多余样式
        commonUtil_1.default.removeExtraAttr(this.style, this.originalStyle, "hover,hoverout,active,activeout,focus,focusout");
    };
    /** 将样式恢复成active或hover或focus或original */
    Component.prototype.restoreStyle = function () {
    ...
    Component.prototype.onFocus = function (mx, my) {
        this.isFocus = true;
        if (this.style.focus) {
    ...
    Component.prototype.onFocusout = function () {
        this.isFocus = false;
        if (this.style.focus) {
    ...
    Component.prototype.onHover = function () {
        this.isHover = true;
        if (this.style.hover) {
        ...
        if (this.style.cursor) {
            globalUtil_1.default.viewState.canvas.style.cursor = this.style.cursor;
        }
        if (this.parent) {
            this.parent.onHover();
        }
    };
    Component.prototype.onHoverout = function () {
        this.isHover = false;
        if (this.style.hover) {
        ...
        if (this.style.cursor) {
            globalUtil_1.default.viewState.canvas.style.cursor = "default";
        }
        if (this.parent) {
            this.parent.onHoverout();
        }
    };
    Component.prototype.onActive = function (mx, my) {
        this.isActive = true;
    ...
    Component.prototype.onActiveout = function () {
        this.isActive = false;
        if (this.style.active) {
    ...
    /** 检查事件是否匹配 */
    Component.prototype.checkEvent = function (eventNotify) {
        var Map = __webpack_require__(9).default;
        if (eventNotify.type) {
            if (eventNotify.type === 1
                && (globalUtil_1.default.action.hoverComponent === this || this.parentOf(globalUtil_1.default.action.hoverComponent))) {
                globalUtil_1.default.eventBus.captureEvent(eventNotify);
            }
            else if (eventNotify.type === 2
                && (globalUtil_1.default.action.focusComponent === this || this instanceof Map)) {
                globalUtil_1.default.eventBus.captureEvent(eventNotify);
            }
            else if (eventNotify.type === 3
                && (globalUtil_1.default.action.focusComponent === this
                    || this.parentOf(globalUtil_1.default.action.focusComponent))) {
                globalUtil_1.default.eventBus.captureEvent(eventNotify);
            }
        }
    };
    /** 冒泡执行doLayout方法 */
    Component.prototype.propagationDoLayout = function (com) {
    ...
    /** 获取所有的权值 */
    Component.prototype.getAllWeight = function () {
        var allWeight = 0;
    ...
    Component.prototype.doLayout = function () {
        ...
        if (this.style.layout && this.style.layout.type && this.children.length > 0) {
            switch (this.style.layout.type) {
                case "linearLayout":
                    var fixByWeight_1 = this.style.layout.fixByWeight || false;
                    var allWeight_1 = 0;
                    if (fixByWeight_1) {
                        allWeight_1 = this.getAllWeight(); //总权值
                    }
                    var allWH_1 = 0; //记录高宽，确定x和y坐标
                    var hY_1 = 0; //horizontal模式下的y坐标
                    var maxHeight_1 = 0; //记录子组件最大高度值，自动换行时有用
                    this.children.forEach(function (child, index) {
                        var weight = 1;
                        if (child.style.layout && child.style.layout.layoutWeight) {
                            weight = child.style.layout.layoutWeight;
                        }
                        if (!_this.style.layout.orientation || _this.style.layout.orientation === "horizontal") {
                            var width = void 0;
                            if (fixByWeight_1) {
                                width = _this.getInnerWidth() * (weight / allWeight_1);
                            }
                            else {
                                width = child.getWidth();
                            }
                            //自动换行（autoWidth时不能自动换行，第一个组件不能执行自动换行）
                            if ((_this.style.layout.autoLine === undefined || _this.style.layout.autoLine === true)
                                && !_this.style.autoWidth && index > 0) {
                                if (allWH_1 + width > _this.getInnerWidth()) {
                                    allWH_1 = 0;
                                    hY_1 += maxHeight_1;
                                    maxHeight_1 = 0;
                                }
                            ...
                            maxHeight_1 = Math.max(maxHeight_1, child.getHeight());
                            allWH_1 += width;
                        }
                        else if (_this.style.layout.orientation === "vertical") {
                            var height = void 0;
                            if (fixByWeight_1) {
                                height = _this.getInnerHeight() * (weight / allWeight_1);
                            }
                            else {
                    ...
                    //自适应高宽
                    var centerOffset = 0; //内容居中时子组件偏移量
                    if (!this.style.layout.orientation || this.style.layout.orientation === "horizontal") {
                        if (this.style.autoWidth) {
                            this.setWidth(allWH_1);
                        }
                        if (!this.style.autoHeight && this.style.layout.contentAlign === "center") {
                            this.children.forEach(function (child, index) {
                                child.setY(_this.getInnerHeight() / 2 - child.getHeight() / 2);
                            });
                        }
                    }
                    else if (this.style.layout.orientation === "vertical") {
                        if (this.style.autoHeight) {
                            this.setHeight(allWH_1);
                        }
                        if (!this.style.autoWidth && this.style.layout.contentAlign === "center") {
                            this.children.forEach(function (child, index) {
                                child.setX(_this.getInnerWidth() / 2 - child.getWidth() / 2);
                            });
                        }
                    }
                    break;
    ...
    /** this是否是com的父亲 */
    Component.prototype.parentOf = function (com) {
        if (!com || !com.parent) {
            return false;
        }
        if (com.parent === this) {
    ...
    /** 执行样式改变动画 */
    Component.prototype.doStyleAnimation = function (styleKey, toVal) {
        if (!this.animation || !this.animation[styleKey]) {
            return;
        }
        return animationUtil_1.default.executeStyleChange(this, styleKey, toVal, this.animation[styleKey]);
    };
    /** 防止改变originalStyle，所以这里要专门写一个方法，而不使用setStyle方法 */
    Component.prototype.copyStyle = function (source) {
        var _loop_1 = function (key) {
            if (key === "backgroundImage") {
                if (this_1.style.backgroundImages && this_1.style.backgroundImages.length > 0) {
                    this_1.style.backgroundImages.forEach(function (bgi) {
                        bgi.dom.src = source[key];
                    });
                }
                else if (this_1.currentBackgroundImage && this_1.currentBackgroundImage.dom) {
                    this_1.currentBackgroundImage.dom.src = source[key];
                }
            }
            if (key === "backgroundImages" && source[key] && source[key].length > 0) {
                this_1.initBackgroundImages(source[key]);
            }
            if (key === "backgroundImagesInterval") {
                this_1.createBackgroundImagesIntervalObj(source[key]);
            }
            if (this_1.animation && this_1.animation[key]) {
                this_1.doStyleAnimation(key, source[key]);
            }
            else {
                this_1.style[key] = source[key];
            }
        };
        var this_1 = this;
    ...
    /** 设置组件样式 */
    Component.prototype.setStyle = function (arg1, arg2, arg3) {
        var allAniPromise;
    ...
    Component.prototype.setStyle_kv = function (key, value, doAni) {
        if (this.originalStyle[key] === value) {
            return;
        }
        ...
        if (key === "backgroundImage") {
            if (this.style.backgroundImages && this.style.backgroundImages.length > 0) {
                this.style.backgroundImages.forEach(function (bgi) {
                    bgi.dom.src = value;
                });
            }
    ...
    Component.prototype.setStyle_obj = function (style, doAni) {
        var aniPromiseArr = [];
        var aniPromise;
    ...
    /** 移除样式 */
    Component.prototype.removeStyle = function (key) {
        delete this.style[key];
        delete this.originalStyle[key];
    };
    Component.prototype.getController = function (com) {
        if (!com.parent) {
    ...
    Component.prototype.getX = function () {
        ...
        if (this.style.x && this.style.x.toString().indexOf("%") > -1) {
    ...
    Component.prototype.getY = function () {
        ...
        if (this.style.y && this.style.y.toString().indexOf("%") > -1) {
    ...
    Component.prototype.setRealX = function (rx) {
        if (this.parent) {
    ...
    Component.prototype.setRealY = function (ry) {
        if (this.parent) {
    ...
    Component.prototype.getRealXRecursion = function (com) {
        if (com.parent) {
    ...
    Component.prototype.getRealX = function () {
        return this.getRealXRecursion(this);
    };
    Component.prototype.getRealYRecursion = function (com) {
        if (com.parent) {
    ...
    Component.prototype.getRealY = function () {
        return this.getRealYRecursion(this);
    };
    /** 获取文本的坐标 */
    Component.prototype.getTextRealX = function () {
        ...
        if (this.text && this.style.textAlign === "center") {
            ...
            if (this instanceof Input) {
                ...
                textLength = globalUtil_1.default.viewState.ctx.measureText(this.getText()).width;
            }
    ...
    Component.prototype.getTextRealY = function () {
    ...
    Component.prototype.getWidth = function () {
        ...
        if (this.style.width.toString().indexOf("%") > -1) {
            var maxWidth = this.parent ? this.parent.getInnerWidth() : globalUtil_1.default.viewState.getWidth();
    ...
    Component.prototype.getHeight = function () {
        ...
        if (this.style.height.toString().indexOf("%") > -1) {
            var maxHeight = this.parent ? this.parent.getInnerHeight() : globalUtil_1.default.viewState.getHeight();
     ...
     * @return true 是0,0
     */
    Component.prototype.needTranslateOriginOfCoor2Center = function () {
        var scale = this.style.scale;
        var rotate = this.style.rotate;
        var mirror = this.style.mirror;
        if ((scale !== undefined && scale !== "1,1")
    ...
    /** 用\n分隔string，实现换行 */
    Component.prototype.getTextForRows = function (text) {
        if (!text) {
            return undefined;
        }
        var rowsStr;
    ...
    Component.prototype.getCharWidth = function (char) {
    ...
    /** 获取文本占的总高度 */
    Component.prototype.getTextHeight = function () {
        if (!this.text) {
            return 0;
        }
        return this.text.length * parseInt(this.style.fontSize, 10);
    };
    Component.prototype.getTextWidth = function () {
        var _this = this;
        if (!this.text) {
            return 0;
        }
        ...
        var allWidth = 0;
        this.text.forEach(function (row, index) {
            if (_this instanceof Input) {
                allWidth = Math.max(allWidth, row.length * parseInt(_this.style.fontSize, 10));
            }
            else {
                allWidth = Math.max(allWidth, globalUtil_1.default.viewState.ctx.measureText(row).width);
            }
        });
        return allWidth;
    };
    ...
    Component.prototype.removeAllChildren = function (name) {
        if (!name) {
    ...
    Component.prototype.registerEvent = function (eventType, callback) {
        globalUtil_1.default.eventBus.registerEvent(this, eventType, callback);
    };
    Component.prototype.removeEvent = function (eventType, callback) {
        globalUtil_1.default.eventBus.removeEvent(this, eventType, callback);
    };
    Component.prototype.removeAllEvent = function () {
        globalUtil_1.default.eventBus.removeAllEvent(this);
    };
    Component.prototype.addEventNotify = function (eventNotify) {
        this.eventNotifys.push(eventNotify);
    };
    //是否支持拖动
    Component.prototype.getDragComponent = function (com) {
    ...
    Component.prototype.getComponentById = function (id) {
        if (this.id && this.id === id) {
            ...
            return globalUtil_1.default.viewState.getComponentInChildrenByKey("id", id, this);
        }
    };
    Component.prototype.getComponentByName = function (name) {
        if (this.name && this.name === name) {
            ...
            return globalUtil_1.default.viewState.getComponentInChildrenByKey("name", name, this);
        }
    };
    /** 用name获取组件集合 */
    Component.prototype.getComponentsByName = function (name) {
        if (this.name && this.name === name) {
            ...
            return globalUtil_1.default.viewState.getComponentsInChildrenByKey("name", name, this);
        }
    };
    /** 用type获取组件集合 */
    Component.prototype.getComponentsByType = function (type) {
        if (this.type && this.type === type) {
            ...
            return globalUtil_1.default.viewState.getComponentsInChildrenByKey("type", type, this);
        }
    };
    /** 触发事件 */
    Component.prototype.triggerEvent = function (type) {
        globalUtil_1.default.eventBus.triggerEvent(type, this);
    };
...
var rect_1 = __webpack_require__(0);
var globalUtil_1 = __webpack_require__(1);
var HOVER_TIME_OUT = 500; //hover时执行定时函数间隔
var Scrollbar = /** @class */ (function (_super) {
    ...
    Scrollbar.prototype.initScrollbar = function () {
        ...
        globalUtil_1.default.viewState.registerEvent("mousemove", this.doMouseMoveBind);
        globalUtil_1.default.viewState.registerEvent("mouseup", this.doMouseUpBind);
        this.registerEvent("mousewheel", this.doMouseWheel.bind(this));
    };
    Scrollbar.prototype.initCfg = function (cfg) {
        var promise = _super.prototype.initCfg.call(this, cfg);
        this.initScrollbar();
        return promise;
    };
    Scrollbar.prototype.draw = function (ctx) {
        if (!_super.prototype.draw.call(this, ctx)) {
            return false;
        }
        if (this.scrollbarBaseLineH && this.scrollbarBaseLineV) {
            if (globalUtil_1.default.action.hoverComponent === this
                || this.parentOf(globalUtil_1.default.action.hoverComponent) || this.onScrollObj) {
    ...
    /** 组件被Hover时执行的定时函数 */
    Scrollbar.prototype.doHoverTimeout = function () {
    ...
    Scrollbar.prototype.onHover = function () {
        _super.prototype.onHover.call(this);
        if (!this.doTimeoutLock) {
            setTimeout(this.doHoverTimeout.bind(this), HOVER_TIME_OUT);
        }
    };
    /** 获取滚动条内容占用的高宽 */
    Scrollbar.prototype.getContentWH = function () {
        var _this = this;
        var maxWidth = 0;
        var maxHeight = 0;
        if (this.style.scrollText && this.text) {
            ...
            this.children.forEach(function (child, index) {
                if (child !== _this.scrollbarBaseLineV && child !== _this.scrollbarBaseLineH) {
    ...
    Scrollbar.prototype.doMouseDown = function (type, e) {
        var x = e.pageX;
        var y = e.pageY;
    ...
    Scrollbar.prototype.doMouseMove = function (e) {
        var x = e.pageX;
        var y = e.pageY;
        if (this.onScrollObj) {
    ...
    Scrollbar.prototype.doMouseUp = function (e) {
        this.onScrollObj = undefined;
    };
    Scrollbar.prototype.doMouseWheel = function (e) {
        if (this.style.contentHeight <= this.getInnerHeight()) {
            return;
        }
    ...
    Scrollbar.prototype.setScrollYValue = function (value) {
        this.setStyle("contentScrollY", value);
        this.setScrollY();
        var scrollObjY = (this.scrollbarBaseLineV.getHeight() - this.scrollbarOpeLineV.getHeight())
            * (value / (this.style.contentHeight - this.getInnerHeight()));
        this.scrollbarOpeLineV.setY(scrollObjY);
    };
    //设置所有子节点的滚动值
    Scrollbar.prototype.setScrollX = function () {
        var _this = this;
        if (this.style.scrollText) {
            ...
            this.children.forEach(function (child) {
                if (child !== _this.scrollbarBaseLineV && child !== _this.scrollbarBaseLineH) {
                    child.setStyle("scrollX", _this.style.contentScrollX);
                }
            });
        }
    };
    Scrollbar.prototype.setScrollY = function () {
        var _this = this;
        if (this.style.scrollText) {
            ...
            this.children.forEach(function (child) {
                if (child !== _this.scrollbarBaseLineV && child !== _this.scrollbarBaseLineH) {
                    child.setStyle("scrollY", _this.style.contentScrollY);
                }
            });
        }
    };
     ...
     */
    Scrollbar.prototype.produceLine = function (oritation, lineColor, alpha) {
        var _this = this;
        var Rect = __webpack_require__(0).default;
        ...
        line.setX(function () {
            return oritation === 1 ? _this.getInnerWidth() - swidth : padding;
        });
        line.setY(function () {
            return oritation === 2 ? _this.getInnerHeight() - swidth : padding;
        });
        if (oritation === 1) {
    ...
    /** 还原滚动条到初始位置 */
    Scrollbar.prototype.restoreScroll = function () {
        this.setStyle({
            contentScrollX: 0,
            contentScrollY: 0
        });
    ...
    Scrollbar.prototype.destroy = function () {
        ...
        globalUtil_1.default.viewState.removeEvent("mousemove", this.doMouseMoveBind);
        globalUtil_1.default.viewState.removeEvent("mouseup", this.doMouseUpBind);
    };
    return Scrollbar;
}(rect_1.default));
...
var Map = /** @class */ (function (_super) {
    ...
    Map.prototype.initCfg = function (cfg) {
        var _this = this;
        var promise = _super.prototype.initCfg.call(this, cfg);
        if (cfg.mapDataUrl) {
            httpUtil_1.default.get(cfg.mapDataUrl).then(function (data) {
                if (data) {
                ...
                _this.mapWidth = data.width;
                _this.mapHeight = data.height;
                _this.mapSize = data.size;
    ...
    //初始化地图数据
    Map.prototype.initMapData = function () {
        this.mapData = [];
                ...
                for (var col = 0; col < this.mapData[row].length; col++) {
                    if (this.mapData[row][col].block || this.mapData[row][col].terrain !== 0) {
                        ...
                        if (this.mapData[row][col].block && this.terrainPolicy.block) {
                            commonUtil_1.default.copyObject(this.terrainPolicy.block, style, true);
                        }
                        if (this.mapData[row][col].terrain !== 0) {
                            commonUtil_1.default.copyObject(this.terrainPolicy[this.mapData[row][col].terrain], style, true);
                        }
                        rect.setStyle(style);
...
var EasePack = __webpack_require__(25);
var animationUtil = {
    /**
     * 执行样式改变动画
     *
     ...
     */
    executeStyleChange: function (com, styleKey, toVal, animation) {
        var to = {};
        to[styleKey] = toVal;
     ...
     * @param animation{duration：间隔时间（单位：秒）；easeType：动画类型（如：Linear或Elastic）；easing：动画执行方式（如：ease或easeOut）；repeat：循环执行的次数}
     */
    executeAttrChange: function (com, to, animation) {
        return new Promise(function (resolve, reject) {
            ...
            animation.duration = commonUtil_1.default.getTimeSecForSuffix(animation.duration);
...
var Router = /** @class */ (function (_super) {
    ...
    function Router(parent) {
        ...
        _this.setY(0);
        if (!parent) {
            _this.setWidth(globalUtil_1.default.viewState.getWidth());
            _this.setHeight(globalUtil_1.default.viewState.getHeight());
        }
        else {
            _this.setWidth("100%");
            _this.setHeight("100%");
    ...
    Router.prototype.initCfg = function (cfg) {
        ...
        if (cfg.routes) {
            var rCfg = void 0;
            for (var name_1 in cfg.routes) {
                rCfg = cfg.routes[name_1];
                this.routes[name_1] = {
                    loader: rCfg.view,
                    isLoaded: false
                };
                if (rCfg.default) {
                    this.currentRoute = name_1;
    ...
    Router.prototype.draw = function (ctx) {
        if (!_super.prototype.draw.call(this, ctx)) {
            return false;
        }
        return true;
    };
    Router.prototype.getChildrenView = function () {
        var _this = this;
        return new Promise(function (resolve) {
            if (!_this.currentChildren) {
                if (_this.routes[_this.currentRoute].isLoaded === false) {
                    var retPromise = _this.produceChildrenByCfg(_this.routes[_this.currentRoute].loader);
                    retPromise.then(function (child) {
                        _this.currentChildren = child;
                        _this.currentChildren.name = _this.currentRoute;
                        _this.currentChildren.active = true;
                        _this.routes[_this.currentRoute].isLoaded = true;
                        //广播视图加载完毕事件
                        var event = {
                            currentTarget: child
                        };
                        globalUtil_1.default.eventBus.broadcastEvent("$onViewLoaded", event, true);
                        resolve();
                    });
                }
                else {
                    _this.children.forEach(function (child) {
                        if (child.name === _this.currentRoute) {
                            _this.currentChildren = child;
                        }
                    });
                    _this.currentChildren.active = true;
     ...
     */
    Router.prototype.changeRoute = function (name, destory) {
    ...
    Router.prototype.destroyRoute = function (name) {
...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.initCfg = function (cfg) {
        var promise = _super.prototype.initCfg.call(this, cfg);
...
var Checkbox = /** @class */ (function (_super) {
    ...
    function Checkbox(parent) {
        ...
        _this.registerEvent("click", function () {
            _this.checked = !_this.checked;
        });
        return _this;
    }
    Checkbox.prototype.initCfg = function (cfg) {
        var promise = _super.prototype.initCfg.call(this, cfg);
    ...
    Checkbox.prototype.draw = function (ctx) {
        ...
        if (this.checked) {
            ...
            ctx.strokeStyle = "#333";
            var oriX = this.getRealX();
            var oriY = this.getRealY();
...
var thread_1 = __webpack_require__(18);
var promise_1 = __webpack_require__(6);
var boxCollisionDetector_1 = __webpack_require__(26);
var Sprite = /** @class */ (function (_super) {
    __extends(Sprite, _super);
    function Sprite(parent) {
        var _this = _super.call(this, parent) || this;
        _this.xSpeed = 0; //大约一毫秒移动的x距离
        _this.ySpeed = 0; //大约一毫秒移动的y距离
        _this.xAcceleration = 0; //x加速度，大约一毫秒增加或减小的速度值
        _this.yAcceleration = 0; //y加速度
        _this.setStyle("zIndex", 1000);
        _this.collisionDetector = new boxCollisionDetector_1.default();
        _this.detectCollisionThread = new thread_1.default(_this.collisionDetector.thread_detectCollision);
        _this.detectXCollisionThread = new thread_1.default(_this.collisionDetector.thread_detectCollision);
        _this.detectYCollisionThread = new thread_1.default(_this.collisionDetector.thread_detectCollision);
        return _this;
    }
    Sprite.prototype.initCfg = function (cfg) {
        var promise = _super.prototype.initCfg.call(this, cfg);
        return promise;
    };
        ...
        if (!this.lastTime) {
            ...
            if (currentTime - this.lastTime >= 1) {
                ...
                if ((this.xSpeed !== 0 || this.ySpeed !== 0) && !this.detectCollisionLock) {
                    ...
                    this.collisionDetector.detectCollision(this, this.getX(), this.getY(), this.detectCollisionThread, true).then(function () {
                    }, function () {
                    }).finally(function () {
                        _this.collisionDetector.detectCollision(_this, _this.getX() + _this.xSpeed, _this.getY() + _this.ySpeed, _this.detectCollisionThread).then(function () {
                            _this.setStyle("x", _this.getX() + _this.xSpeed);
                            _this.setStyle("y", _this.getY() + _this.ySpeed);
                            _this.detectCollisionLock = false;
                        }, function () {
                            //x或y方向发生碰撞，则只移动x或y
                            var promise1 = new promise_1.default();
                            _this.collisionDetector.detectCollision(_this, _this.getX() + _this.xSpeed, _this.getY(), _this.detectXCollisionThread).then(function () {
                                _this.setStyle("x", _this.getX() + _this.xSpeed);
                            }, function () {
                                _this.xSpeed = 0;
                            }).finally(function () {
                            ...
                            var promise2 = new promise_1.default();
                            _this.collisionDetector.detectCollision(_this, _this.getX(), _this.getY() + _this.ySpeed, _this.detectYCollisionThread).then(function () {
                                _this.setStyle("y", _this.getY() + _this.ySpeed);
                            }, function () {
                                _this.ySpeed = 0;
                            }).finally(function () {
                            ...
                            Promise.all([promise1, promise2]).then(function () {
                                _this.detectCollisionLock = false;
                                if (_this.onCollision && typeof (_this.onCollision) === "function") {
                                    _this.onCollision.apply(_this, []);
                                }
                            });
                        });
                    });
...
var Thread = /** @class */ (function () {
    function Thread(fun) {
        ...
        if (typeof (Worker) !== "undefined") {
            ...
            var textDom = document.createTextNode("self.onmessage=" + fun.toString());
            scriptDom.appendChild(textDom);
            var blob = new Blob([scriptDom.text], { type: "text/plain" });
            this.worker = new Worker(window.URL.createObjectURL(blob));
            this.worker.onmessage = function (e) {
                if (_this.callbackPromise) {
                    _this.callbackPromise.resolve(e.data);
                }
            };
        }
    }
     ...
     */
    Thread.prototype.run = function (data, replacer) {
        var sendData;
        ...
        this.callbackPromise = new promise_1.default();
...
var Controller = /** @class */ (function () {
    ...
    Controller.prototype.registerEvent = function (eventType, callback) {
        globalUtil_1.default.eventBus.registerEvent(this, eventType, callback);
    };
    Controller.prototype.removeEvent = function (eventType, callback) {
        globalUtil_1.default.eventBus.removeEvent(this, eventType, callback);
    };
    Controller.prototype.removeAllEvent = function () {
        globalUtil_1.default.eventBus.removeAllEvent(this);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var globalUtil_1 = __webpack_require__(1);
var viewState_1 = __webpack_require__(23);
var eventBus_1 = __webpack_require__(28);
var Fps = /** @class */ (function () {
    function Fps(mainBody) {
        ...
        globalUtil_1.default.eventBus = new eventBus_1.default(this.canvas);
    }
    Fps.prototype.offset = function (element) {
    ...
    Fps.prototype.setMainView = function (viewCfg) {
        this.viewState = new viewState_1.default(this.canvas, this.ctx);
        globalUtil_1.default.viewState = this.viewState;
        globalUtil_1.default.viewState.init(viewCfg);
    };
    /** 开始循环绘制 */
    Fps.prototype.startLoop = function () {
        window.requestAnimationFrame(this.draw.bind(this));
    };
    /** 绘制子组件之前调用 */
    Fps.prototype.beforeDrawChildren = function (com) {
        this.ctx.save();
        /** 防止children超出 */
        if (com.setClip) {
    ...
    Fps.prototype.afterDrawChildren = function (com) {
        if (com.setClip) {
            com.isDoingParentClip = false;
        }
        this.ctx.restore();
    };
    Fps.prototype.drawView = function (com) {
        if (!com.active) {
            return;
        }
        if (com.draw(this.ctx)) {
            ...
            if (children) {
                ...
                if (children instanceof Array) {
                    if (!com.isSort) {
                        children.sort(function (a, b) { return a.style.zIndex - b.style.zIndex; }); //zIndex升序排序
                        com.isSort = true;
                    }
                    var child = void 0;
    ...
    Fps.prototype.draw = function () {
        ...
        globalUtil_1.default.viewState.beforeDraw(this.ctx);
        this.drawView(globalUtil_1.default.viewState.rootComponent);
        globalUtil_1.default.viewState.afterDraw(this.ctx);
        window.requestAnimationFrame(this.draw.bind(this));
    };
    return Fps;
}());
...
var input_1 = __webpack_require__(2);
var dragEvent_1 = __webpack_require__(27);
var ViewState = /** @class */ (function () {
    function ViewState(canvas, ctx) {
        var _this = this;
        this.ctx = ctx;
        this.canvas = canvas;
        ...
        this.registerEvent("mousedown", function (e) {
            if (e.sourceEvent.target !== _this.canvas) {
                return;
            }
            if (globalUtil_1.default.action.hoverComponent) {
                if (globalUtil_1.default.action.focusComponent) {
                    globalUtil_1.default.action.focusComponent.onFocusout();
                }
                globalUtil_1.default.action.focusComponent = globalUtil_1.default.action.hoverComponent;
                if (globalUtil_1.default.action.focusComponent.onFocus && typeof (globalUtil_1.default.action.focusComponent.onFocus) === "function") {
                    globalUtil_1.default.action.focusComponent.onFocus(e.pageX, e.pageY);
                }
                globalUtil_1.default.action.activeComponent = globalUtil_1.default.action.hoverComponent;
                globalUtil_1.default.action.activeComponent.onActive(e.pageX, e.pageY);
                //是否支持拖动
                if (e.button === 0) {
                    globalUtil_1.default.action.dragComponent = globalUtil_1.default.action.hoverComponent.getDragComponent(globalUtil_1.default.action.hoverComponent);
                    if (globalUtil_1.default.action.dragComponent) {
                        globalUtil_1.default.action.dragOffset = {
                            x: e.pageX - globalUtil_1.default.action.dragComponent.getRealX(),
                            y: e.pageY - globalUtil_1.default.action.dragComponent.getRealY()
                        };
                        var event_1 = new dragEvent_1.default("startDrag");
                        event_1.setPageX(globalUtil_1.default.action.dragOffset.x);
                        event_1.setPageY(globalUtil_1.default.action.dragOffset.y);
                        event_1.setCurrentTarget(globalUtil_1.default.action.dragComponent);
                        globalUtil_1.default.eventBus.broadcastEvent("startDrag", event_1, true);
                    }
                }
            }
        });
        this.registerEvent("mouseup", function (e) {
            if (e.sourceEvent.target === _this.canvas) {
                globalUtil_1.default.action.inputListenerDom.focus();
                if (globalUtil_1.default.action.activeComponent) {
                    globalUtil_1.default.action.activeComponent.onActiveout();
                    globalUtil_1.default.action.activeComponent = undefined;
                }
            }
            if (globalUtil_1.default.action.dragComponent) {
                var event_2 = new dragEvent_1.default("endDrag");
                event_2.setPageX(globalUtil_1.default.action.dragOffset.x);
                event_2.setPageY(globalUtil_1.default.action.dragOffset.y);
                event_2.setCurrentTarget(globalUtil_1.default.action.dragComponent);
                globalUtil_1.default.eventBus.broadcastEvent("endDrag", event_2, true);
                globalUtil_1.default.action.dragComponent = undefined;
                globalUtil_1.default.action.dragOffset = undefined;
            }
        });
        this.registerEvent("mousemove", function (e) {
            if (e.sourceEvent.target === _this.canvas) {
                _this.ctx.mouseAction.mx = e.pageX - _this.ctx.canvasOffset.left;
                _this.ctx.mouseAction.my = e.pageY - _this.ctx.canvasOffset.top;
            }
            if (globalUtil_1.default.action.dragComponent) {
                globalUtil_1.default.action.dragComponent.setRealX(e.pageX - globalUtil_1.default.action.dragOffset.x);
                globalUtil_1.default.action.dragComponent.setRealY(e.pageY - globalUtil_1.default.action.dragOffset.y);
                var event_3 = new dragEvent_1.default("onDrag");
                event_3.setPageX(globalUtil_1.default.action.dragOffset.x);
                event_3.setPageY(globalUtil_1.default.action.dragOffset.y);
                event_3.setCurrentTarget(globalUtil_1.default.action.dragComponent);
                globalUtil_1.default.eventBus.broadcastEvent("onDrag", event_3, true);
            }
        });
        //输入框事件
        globalUtil_1.default.action.inputListenerDom.compositionMode = false; //是否输入法状态
        globalUtil_1.default.eventBus.addEventListener(globalUtil_1.default.action.inputListenerDom, "compositionstart", function (e) {
            globalUtil_1.default.action.inputListenerDom.compositionMode = true;
        });
        globalUtil_1.default.eventBus.addEventListener(globalUtil_1.default.action.inputListenerDom, "compositionend", function (e) {
            globalUtil_1.default.action.inputListenerDom.compositionMode = false;
            if (globalUtil_1.default.action.focusComponent && globalUtil_1.default.action.focusComponent instanceof input_1.default) {
                _this.setVal2FocusCom();
            }
        });
        globalUtil_1.default.eventBus.addEventListener(globalUtil_1.default.action.inputListenerDom, "input", function (e) {
            if (!globalUtil_1.default.action.inputListenerDom.compositionMode
                && globalUtil_1.default.action.focusComponent && globalUtil_1.default.action.focusComponent instanceof input_1.default) {
                _this.setVal2FocusCom();
            }
        });
    }
    ViewState.prototype.init = function (viewCfg) {
        if (viewCfg.type == "rect") {
            this.rootComponent = new rect_1.default();
        }
        else if (viewCfg.type == "route") {
            this.rootComponent = new router_1.default();
        }
        this.rootComponent.initCfg(viewCfg).then(function () {
            globalUtil_1.default.eventBus.broadcastEvent("$onViewLoaded"); //view加载完成事件（所有同步加载的视图加载完毕）
        });
    };
    /** 绘制前 */
    ViewState.prototype.beforeDraw = function (ctx) {
        //通知触发事件
        globalUtil_1.default.eventBus.doNotifyEvent();
        ctx.mouseAction.hoverCom = undefined;
    };
    /** 绘制后 */
    ViewState.prototype.afterDraw = function (ctx) {
        globalUtil_1.default.eventBus.propagationEvent();
        //全部绘制完后检查hover的组件，并且上一次hover的组件和这一次的不能相同
        if (ctx.mouseAction.hoverCom) {
            //这一次hover的组件不等于上一次hover的组件，则表示上一次hover的组件hoverout了
            if (globalUtil_1.default.action.hoverComponent !== ctx.mouseAction.hoverCom) {
                if (globalUtil_1.default.action.hoverComponent) {
                    globalUtil_1.default.action.hoverComponent.onHoverout();
                }
                globalUtil_1.default.action.hoverComponent = ctx.mouseAction.hoverCom;
                globalUtil_1.default.action.hoverComponent.onHover();
            }
        }
    };
    /** 将textarea中的值设置到焦点组件 */
    ViewState.prototype.setVal2FocusCom = function () {
        if (!globalUtil_1.default.action.focusComponent.style.readOnly) {
            globalUtil_1.default.action.focusComponent.setText(globalUtil_1.default.action.inputListenerDom.value);
            globalUtil_1.default.action.inputListenerDom.text = globalUtil_1.default.action.focusComponent.getText() || "";
        }
    };
    ViewState.prototype.addEventNotify = function (eventNotify) {
        globalUtil_1.default.eventBus.captureEvent(eventNotify); //为了最后执行mousedown事件，必须第一个占坑
    };
    ViewState.prototype.getComponentInChildrenByKey = function (key, val, com) {
        var children = com.getChildren();
        if (children) {
            var retCom = void 0;
            if (children instanceof Array) {
    ...
    ViewState.prototype._getComponentsInChildrenByKey = function (retArr, key, val, com) {
        var children = com.getChildren();
        if (children) {
            if (children instanceof Array) {
                var child = void 0;
    ...
    /** 用key获取组件列表 */
    ViewState.prototype.getComponentsInChildrenByKey = function (key, val, com) {
        var retArr = [];
        this._getComponentsInChildrenByKey(retArr, key, val, com);
        return retArr;
    };
    ViewState.prototype.getComponentById = function (id) {
    ...
    ViewState.prototype.getComponentByName = function (name) {
        if (this.rootComponent.name && this.rootComponent.name === name) {
            return this.rootComponent;
        }
        else {
            return globalUtil_1.default.viewState.getComponentInChildrenByKey("name", name, this.rootComponent);
        }
    };
    /** 用name获取组件集合 */
    ViewState.prototype.getComponentsByName = function (name) {
        if (this.rootComponent.name && this.rootComponent.name === name) {
            return [this.rootComponent];
        }
        else {
    ...
    /** 用type获取组件集合 */
    ViewState.prototype.getComponentsByType = function (type) {
    ...
    ViewState.prototype.getWidth = function () {
        return this.ctx.canvas.width;
    };
    ViewState.prototype.getHeight = function () {
        return this.ctx.canvas.height;
    };
    ViewState.prototype.registerEvent = function (eventType, callback) {
        globalUtil_1.default.eventBus.registerEvent(this, eventType, callback);
    };
    ViewState.prototype.removeEvent = function (eventType, callback) {
        globalUtil_1.default.eventBus.removeEvent(this, eventType, callback);
    };
    ViewState.prototype.removeAllEvent = function () {
        globalUtil_1.default.eventBus.removeAllEvent(this);
    };
    return ViewState;
}());
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    "use strict";
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) { var d = function (a) { var b, c = [], d = a.length; for (b = 0; b !== d; c.push(a[b++]))
        ; return c; }, e = function (a, b, c) { var d, e, f = a.cycle; for (d in f)
        ...
        g = i[h], (k || g instanceof b || (f = g.target === g.vars.onComplete) && d || c && !f) && (a ? g.totalTime(g._reversed ? 0 : g.totalDuration()) : g._enabled(!1, !1)); }, f.killChildTweensOf = function (a, b) { if (null != a) {
    ...
    } }; var o = function (a, c, d, e) { c = c !== !1, d = d !== !1, e = e !== !1; for (var f, g, h = n(e), i = c && d && e, j = h.length; --j > -1;)
        ...
        c = e[d], i(c) && -1 !== c.join("").indexOf("{self}") && (e[d] = this._swapSelfInParams(c)); i(e.tweens) && this.add(e.tweens, 0, e.align, e.stagger); }, e = 1e-10, f = c._internals, g = d._internals = {}, h = f.isSelector, i = f.isArray, j = f.lazyTweens, k = f.lazyRender, l = _gsScope._gsDefine.globals, m = function (a) { var b, c = {}; for (b in a)
        c[b] = a[b]; return c; }, n = function (a, b, c) { var d, e, f = a.cycle; for (d in f)
        e = f[d], a[d] = "function" == typeof e ? e(c, b[c]) : e[c % e.length]; delete a.cycle; }, o = g.pauseCallback = function () { }, p = function (a) { var b, c = [], d = a.length; for (b = 0; b !== d; c.push(a[b++]))
        ; return c; }, q = d.prototype = new b; return d.version = "1.20.2", q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function (a, b, d, e) { var f = d.repeat && l.TweenMax || c; return b ? this.add(new f(a, b, d), e) : this.set(a, d, e); }, q.from = function (a, b, d, e) { return this.add((d.repeat && l.TweenMax || c).from(a, b, d), e); }, q.fromTo = function (a, b, d, e, f) { var g = e.repeat && l.TweenMax || c; return b ? this.add(g.fromTo(a, b, d, e), f) : this.set(a, e, f); }, q.staggerTo = function (a, b, e, f, g, i, j, k) { var l, o, q = new d({ onComplete: i, onCompleteParams: j, callbackScope: k, smoothChildTiming: this.smoothChildTiming }), r = e.cycle; for ("string" == typeof a && (a = c.selector(a) || a), a = a || [], h(a) && (a = p(a)), f = f || 0, 0 > f && (a = p(a), a.reverse(), f *= -1), o = 0; o < a.length; o++)
        ...
        f = e._next, b && e instanceof c && e.target === e.vars.onComplete || g.add(e, e._startTime - e._delay), e = f; return h.add(g, 0), g; }, q.add = function (e, f, g, h) { var j, k, l, m, n, o; if ("number" != typeof f && (f = this._parseTimeOrLabel(f, 0, !0, e)), !(e instanceof a)) {
        ...
        for (n = this, o = n.rawTime() > e._startTime; n._timeline;)
            o && n._timeline.smoothChildTiming ? n.totalTime(n._totalTime, !0) : n._gc && n._enabled(!0, !1), n = n._timeline; return this; }, q.remove = function (b) { if (b instanceof a) {
        this._remove(b, !1);
        ...
        for (g = e.length; --g > -1;)
            e[g] instanceof a && e[g].timeline === this && this.remove(e[g]); if (f = this.duration() > 99999999999 ? this.recent().endTime(!1) : this._duration, "string" == typeof c)
    ...
    } }, q._hasPausedChild = function () { for (var a = this._first; a;) {
        ...
        (d[e].timeline === this || b && this._contains(d[e])) && (g[h++] = d[e]); return f && this._enabled(!1, !0), g; }, q.recent = function () { return this._recent; }, q._contains = function (a) { for (var b = a.timeline; b;) {
        if (b === this)
            return !0;
        b = b.timeline;
        ...
        for (d in f)
            f[d] >= c && (f[d] += a); return this._uncache(!0); }, q._kill = function (a, b) { if (!a && !b)
        ...
        if (null == b)
            ...
            for (var c = this.getTweensOf(a, !1), d = c.length, e = this._parseTimeOrLabel(b); --d > -1;)
                c[d]._startTime === e && c[d]._enabled(!1, !1); return this; }, k.removePause = function (b) { return this.removeCallback(a._internals.pauseCallback, b); }, k.tweenTo = function (a, c) { c = c || {}; var d, e, f, g = { ease: j, useFrames: this.usesFrames(), immediateRender: !1 }, h = c.repeat && i.TweenMax || b; for (e in c)
        g[e] = c[e]; return g.time = this._parseTimeOrLabel(a), d = Math.abs(Number(g.time) - this._time) / this._timeScale || .001, f = new h(this, d, g), g.onStart = function () { f.target.paused(!0), f.vars.time !== f.target.time() && d === f.duration() && f.duration(Math.abs(f.vars.time - f.target.time()) / f.target._timeScale), c.onStart && c.onStart.apply(c.onStartScope || c.callbackScope || f, c.onStartParams || []); }, f; }, k.tweenFromTo = function (a, b, c) { c = c || {}, a = this._parseTimeOrLabel(a), c.startAt = { onComplete: this.seek, onCompleteParams: [a], callbackScope: this }, c.immediateRender = c.immediateRender !== !1; var d = this.tweenTo(b, c); return d.duration(Math.abs(d.vars.time - a) / this._timeScale || .001); }, k.render = function (a, b, c) { this._gc && this._enabled(!0, !1); var d, f, i, j, k, l, m, n, o = this._dirty ? this.totalDuration() : this._totalDuration, p = this._duration, q = this._time, r = this._totalTime, s = this._startTime, t = this._timeScale, u = this._rawPrevTime, v = this._paused, w = this._cycle; if (a >= o - 1e-7 && a >= 0)
        ...
        for (d = this._last; d && (i = d._prev, n === this._time && (!this._paused || v));) {
            ...
            d = i;
        } this._onUpdate && (b || (g.length && h(), this._callback("onUpdate"))), j && (this._locked || this._gc || (s === this._startTime || t !== this._timeScale) && (0 === this._time || o >= this.totalDuration()) && (f && (g.length && h(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !b && this.vars[j] && this._callback(j))); }, k.getActive = function (a, b, c) { null == a && (a = !0), null == b && (b = !0), null == c && (c = !1); var d, e, f = [], g = this.getChildren(a, b, c), h = 0, i = g.length; for (d = 0; i > d; d++)
        e = g[d], e.isActive() && (f[h++] = e); return f; }, k.getLabelAfter = function (a) { a || 0 !== a && (a = this._time); var b, c = this.getLabelsArray(), d = c.length; for (b = 0; d > b; b++)
        if (c[b].time > a)
            return c[b].name; return null; }, k.getLabelBefore = function (a) { null == a && (a = this._time); for (var b = this.getLabelsArray(), c = b.length; --c > -1;)
        if (b[c].time < a)
        ...
        var a = 180 / Math.PI, b = [], c = [], d = [], e = {}, f = _gsScope._gsDefine.globals, g = function (a, b, c, d) { c === d && (c = d - (d - b) / 1e6), a === b && (b = a + (c - a) / 1e6), this.a = a, this.b = b, this.c = c, this.d = d, this.da = d - a, this.ca = c - a, this.ba = b - a; }, h = ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,", i = function (a, b, c, d) { var e = { a: a }, f = {}, g = {}, h = { c: d }, i = (a + b) / 2, j = (b + c) / 2, k = (c + d) / 2, l = (i + j) / 2, m = (j + k) / 2, n = (m - l) / 8; return e.b = i + (a - i) / 4, f.b = l + n, e.c = f.a = (e.b + f.b) / 2, f.c = g.a = (l + m) / 2, g.b = m - n, h.b = k + (d - k) / 4, g.c = h.a = (g.b + h.b) / 2, [e, f, g, h]; }, j = function (a, e, f, g, h) { var j, k, l, m, n, o, p, q, r, s, t, u, v, w = a.length - 1, x = 0, y = a[0].a; for (j = 0; w > j; j++)
            n = a[x], k = n.a, l = n.d, m = a[x + 1].d, h ? (t = b[j], u = c[j], v = (u + t) * e * .25 / (g ? .5 : d[j] || .5), o = l - (l - k) * (g ? .5 * e : 0 !== t ? v / t : 0), p = l + (m - l) * (g ? .5 * e : 0 !== u ? v / u : 0), q = l - (o + ((p - o) * (3 * t / (t + u) + .5) / 4 || 0))) : (o = l - (l - k) * e * .5, p = l + (m - l) * e * .5, q = l - (o + p) / 2), o += q, p += q, n.c = r = o, 0 !== j ? n.b = y : n.b = y = n.a + .6 * (n.c - n.a), n.da = l - k, n.ca = r - k, n.ba = y - k, f ? (s = i(k, y, r, l), a.splice(x, 1, s[0], s[1], s[2], s[3]), x += 4) : x++, y = p; n = a[x], n.b = y, n.c = y + .4 * (n.d - y), n.da = n.d - n.a, n.ca = n.c - n.a, n.ba = y - n.a, f && (s = i(n.a, y, n.c, n.d), a.splice(x, 1, s[0], s[1], s[2], s[3])); }, k = function (a, d, e, f) { var h, i, j, k, l, m, n = []; if (f)
            ...
            j = a[i][d], k = a[i + 1][d], n[i] = new g(j, 0, 0, k), e && (l = a[i + 2][d], b[i] = (b[i] || 0) + (k - j) * (k - j), c[i] = (c[i] || 0) + (l - k) * (l - k)); return n[i] = new g(a[i][d], 0, 0, a[i + 1][d]), n; }, l = function (a, f, g, i, l, m) { var n, o, p, q, r, s, t, u, v = {}, w = [], x = m || a[0]; l = "string" == typeof l ? "," + l + "," : h, null == f && (f = 1); for (o in a[0])
            ...
            b[n] = Math.sqrt(b[n]), c[n] = Math.sqrt(c[n]); if (!i) {
            for (n = w.length; --n > -1;)
                if (e[o])
            ...
            o = w[n], p = v[o], j(p, f, g, i, e[o]), t && (p.splice(0, q), p.splice(p.length - q, q)); return v; }, m = function (a, b, c) {
            b = b || "soft";
            ...
            for (m = a[p], f = m.a, g = m.d - f, h = m.c - f, i = m.b - f, d = e = 0, k = 1; c >= k; k++)
                j = o * k, l = 1 - j, d = e - (e = (j * j * g + 3 * l * (j * h + l * i)) * j), n = p * c + k - 1, b[n] = (b[n] || 0) + d * d; }, o = function (a, b) { b = b >> 0 || 6; var c, d, e, f, g = [], h = [], i = 0, j = 0, k = b - 1, l = [], m = []; for (c in a)
            n(a[c], g, b); for (e = g.length, d = 0; e > d; d++)
            i += Math.sqrt(g[d]), f = d % b, m[f] = i, f === k && (j += i, f = d / b >> 0, l[f] = m, h[f] = j, i = 0, m = []); return { length: j, lengths: h, segments: l }; }, p = _gsScope._gsDefine.plugin({ propName: "bezier", priority: -1, version: "1.3.8", API: 2, global: !0, init: function (a, b, c) { this._target = a, b instanceof Array && (b = { values: b }), this._func = {}, this._mod = {}, this._props = [], this._timeRes = null == b.timeResolution ? 6 : parseInt(b.timeResolution, 10); var d, e, f, g, h, i = b.values || [], j = {}, k = i[0], n = b.autoRotate || c.vars.orientToBezier; this._autoRotate = n ? n instanceof Array ? n : [["x", "y", "rotation", n === !0 ? 0 : Number(n) || 0]] : null; for (d in k)
                ...
                } return this._startRatio = c.vars.runBackwards ? 1 : 0, !0; }, set: function (b) { var c, d, e, f, g, h, i, j, k, l, m = this._segCount, n = this._func, o = this._target, p = b !== this._startRatio; if (this._timeRes) {
        ...
        p.bezierThrough = l, p.cubicToQuadratic = i, p._autoCSS = !0, p.quadraticToCubic = function (a, b, c) { return new g(a, (2 * b + a) / 3, (2 * b + c) / 3, c); }, p._cssRegister = function () { var a = f.CSSPlugin; if (a) {
            var b = a._internals, c = b._parseToProxy, d = b._setPluginRatio, e = b.CSSPropTween;
            b._registerComplexSpecialProp("bezier", { parser: function (a, b, f, g, h, i) { b instanceof Array && (b = { values: b }), i = new p; var j, k, l, m = b.values, n = m.length - 1, o = [], q = {}; if (0 > n)
        ...
        var c, d, e, f, g = function () { a.call(this, "css"), this._overwriteProps.length = 0, this.setRatio = g.prototype.setRatio; }, h = _gsScope._gsDefine.globals, i = {}, j = g.prototype = new a("css");
        ...
        var k, l, m, n, o, p, q, r, s = /(?:\-|\.|\b)(\d|\.|e\-)+/g, t = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, u = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, w = /(?:\d|\-|\+|=|#|\.)*/g, x = /opacity *= *([^)]*)/i, y = /opacity:([^;]*)/i, z = /alpha\(opacity *=.+?\)/i, A = /^(rgb|hsl)/, B = /([A-Z])/g, C = /-([a-z])/gi, D = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, E = function (a, b) { return b.toUpperCase(); }, F = /(?:Left|Right|Width)/i, G = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, H = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, I = /,(?=[^\)]*(?:\(|$))/gi, J = /[\s,\(]/i, K = Math.PI / 180, L = 180 / Math.PI, M = {}, N = { style: {} }, O = _gsScope.document || { createElement: function () { return N; } }, P = function (a, b) { return O.createElementNS ? O.createElementNS(b || "http://www.w3.org/1999/xhtml", a) : O.createElement(a); }, Q = P("div"), R = P("img"), S = g._internals = { _specialProps: i }, T = (_gsScope.navigator || {}).userAgent || "", U = function () { var a = T.indexOf("Android"), b = P("a"); return m = -1 !== T.indexOf("Safari") && -1 === T.indexOf("Chrome") && (-1 === a || parseFloat(T.substr(a + 8, 2)) > 3), o = m && parseFloat(T.substr(T.indexOf("Version/") + 8, 2)) < 6, n = -1 !== T.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(T) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(T)) && (p = parseFloat(RegExp.$1)), b ? (b.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(b.style.opacity)) : !1; }(), V = function (a) { return x.test("string" == typeof a ? a : (a.currentStyle ? a.currentStyle.filter : a.style.filter) || "") ? parseFloat(RegExp.$1) / 100 : 1; }, W = function (a) { _gsScope.console && console.log(a); }, X = "", Y = "", Z = function (a, b) { b = b || Q; var c, d, e = b.style; if (void 0 !== e[a])
            ...
            return 0; var h, i, j, k = F.test(c), l = a, m = Q.style, n = 0 > d, o = 1 === d; if (n && (d = -d), o && (d *= 100), "lineHeight" !== c || e)
            ...
            i = $(a).lineHeight, a.style.lineHeight = d, h = parseFloat($(a).lineHeight), a.style.lineHeight = i; return o && (h /= 100), n ? -h : h; }, ba = S.calculateOffset = function (a, b, c) { if ("absolute" !== _(a, "position", c))
            return 0; var d = "left" === b ? "Left" : "Top", e = _(a, "margin" + d, c); return a["offset" + d] - (aa(a, b, parseFloat(e), e.replace(w, "")) || 0); }, ca = function (a, b) { var c, d, e, f = {}; if (b = b || $(a, null))
            if (c = b.length)
                for (; --c > -1;)
            ...
            return a.getBBox()[b] || 0; var d = parseFloat("width" === b ? a.offsetWidth : a.offsetHeight), e = ea[b], f = e.length; for (c = c || $(a, null); --f > -1;)
            d -= parseFloat(_(a, "padding" + e[f], c, !0)) || 0, d -= parseFloat(_(a, "border" + e[f] + "Width", c, !0)) || 0; return d; }, ha = function (a, b) { if ("contain" === a || "auto" === a || "auto auto" === a)
            return a + " "; (null == a || "" === a) && (a = "0 0"); var c, d = a.split(" "), e = -1 !== a.indexOf("left") ? "0%" : -1 !== a.indexOf("right") ? "100%" : d[0], f = -1 !== a.indexOf("top") ? "0%" : -1 !== a.indexOf("bottom") ? "100%" : d[1]; if (d.length > 3 && !b) {
            ...
            c = la.black; return b && !m && (d = c[0] / 255, e = c[1] / 255, f = c[2] / 255, j = Math.max(d, e, f), k = Math.min(d, e, f), i = (j + k) / 2, j === k ? g = h = 0 : (l = j - k, h = i > .5 ? l / (2 - j - k) : l / (j + k), g = j === d ? (e - f) / l + (f > e ? 6 : 0) : j === e ? (f - d) / l + 2 : (d - e) / l + 4, g *= 60), c[0] = g + .5 | 0, c[1] = 100 * h + .5 | 0, c[2] = 100 * i + .5 | 0), c; }, oa = function (a, b) { var c, d, e, f = a.match(pa) || [], g = 0, h = ""; if (!f.length)
            return a; for (c = 0; c < f.length; c++)
            d = f[c], e = a.substr(g, a.indexOf(d, g) - g), g += e.length + d.length, d = na(d, b), 3 === d.length && d.push(1), h += e + (b ? "hsla(" + d[0] + "," + d[1] + "%," + d[2] + "%," + d[3] : "rgba(" + d.join(",")) + ")"; return h + a.substr(g); }, pa = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";
        for (j in la)
            pa += "|" + j + "\\b";
        pa = new RegExp(pa + ")", "gi"), g.colorStringFilter = function (a) { var b, c = a[0] + " " + a[1]; pa.test(c) && (b = -1 !== c.indexOf("hsl(") || -1 !== c.indexOf("hsla("), a[0] = oa(a[0], b), a[1] = oa(a[1], b)), pa.lastIndex = 0; }, b.defaultStringFilter || (b.defaultStringFilter = g.colorStringFilter);
        var qa = function (a, b, c, d) { if (null == a)
            return function (a) { return a; }; var e, f = b ? (a.match(pa) || [""])[0] : "", g = a.split(f).join("").match(u) || [], h = a.substr(0, a.indexOf(g[0])), i = ")" === a.charAt(a.length - 1) ? ")" : "", j = -1 !== a.indexOf(" ") ? " " : ",", k = g.length, l = k > 0 ? g[0].replace(s, "") : ""; return k ? e = b ? function (a) { var b, m, n, o; if ("number" == typeof a)
            a += l;
        else if (d && I.test(a)) {
            ...
            for (; ++n < k;)
                m[n] = c ? m[(n - 1) / 2 | 0] : g[n]; return h + m.join(j) + j + b + i + (-1 !== a.indexOf("inset") ? " inset" : ""); } : function (a) { var b, f, m; if ("number" == typeof a)
            a += l;
        else if (d && I.test(a)) {
            ...
            h[a[i]] = j[i] = j[i] || j[(i - 1) / 2 >> 0]; return e.parse(b, h, f, g); }; }, sa = (S._setPluginRatio = function (a) { this.plugin.setRatio(a); for (var b, c, d, e, f, g = this.data, h = g.proxy, i = g.firstMPT, j = 1e-6; i;)
            ...
            for (i = g.firstMPT, f = 1 === a ? "e" : "b"; i;) {
                if (c = i.t, c.type) {
                    ...
                    c[f] = c.s + c.xs0;
                i = i._next;
            } }, function (a, b, c, d, e) { this.t = a, this.p = b, this.v = c, this.r = e, d && (d._prev = this, this._next = d); }), ta = (S._parseToProxy = function (a, b, c, d, e, f) { var g, h, i, j, k, l = d, m = {}, n = {}, o = c._transform, p = M; for (c._transform = null, M = b, d = k = c.parse(a, b, d, e), M = p, f && (c._transform = o, l && (l._prev = null, l._prev && (l._prev._next = null))); d && d !== l;) {
        ...
        j = xa.prototype, j.parseComplex = function (a, b, c, d, e, f) { var g, h, i, j, k, l, m = this.keyword; if (this.multi && (I.test(c) || I.test(b) ? (h = b.replace(I, "|").split("|"), i = c.replace(I, "|").split("|")) : m && (h = [b], i = [c])), i) {
        ...
        var Aa, Ba = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Ca = Z("transform"), Da = X + "transform", Ea = Z("transformOrigin"), Fa = null !== Z("perspective"), Ga = S.Transform = function () { this.perspective = parseFloat(g.defaultTransformPerspective) || 0, this.force3D = g.defaultForce3D !== !1 && Fa ? g.defaultForce3D || "auto" : !1; }, Ha = _gsScope.SVGElement, Ia = function (a, b, c) { var d, e = O.createElementNS("http://www.w3.org/2000/svg", a), f = /([a-z])([A-Z])/g; for (d in c)
            ...
            this._originalGetBBox && (b = this._originalGetBBox()); return e ? d.insertBefore(this, e) : d.appendChild(this), Ja.removeChild(c), this.style.cssText = f, b; }, Na = function (a) { try {
            return a.getBBox();
        }
        catch (b) {
            return Ma.call(a, !0);
        } }, Oa = function (a) { return !(!(Ha && a.getCTM && Na(a)) || a.parentNode && !a.ownerSVGElement); }, Pa = [1, 0, 0, 1, 0, 0], Qa = function (a, b) { var c, d, e, f, g, h, i = a._gsTransform || new Ga, j = 1e5, k = a.style; if (Ca ? d = _(a, Da, null, !0) : a.currentStyle && (d = a.currentStyle.filter.match(G), d = d && 4 === d.length ? [d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), i.x || 0, i.y || 0].join(",") : ""), c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d, !Ca || !(h = "none" === $(a).display) && a.parentNode || (h && (f = k.display, k.display = "block"), a.parentNode || (g = 1, Ja.appendChild(a)), d = _(a, Da, null, !0), c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d, f ? k.display = f : h && Va(k, "display"), g && Ja.removeChild(a)), (i.svg || a.getCTM && Oa(a)) && (c && -1 !== (k[Ca] + "").indexOf("matrix") && (d = k[Ca], c = 0), e = a.getAttribute("transform"), c && e && (-1 !== e.indexOf("matrix") ? (d = e, c = 0) : -1 !== e.indexOf("translate") && (d = "matrix(1,0,0,1," + e.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", c = 0))), c)
            return Pa; for (e = (d || "").match(s) || [], wa = e.length; --wa > -1;)
            f = Number(e[wa]), e[wa] = (g = f - (f |= 0)) ? (g * j + (0 > g ? -.5 : .5) | 0) / j + f : f; return b && e.length > 6 ? [e[0], e[1], e[4], e[5], e[12], e[13]] : e; }, Ra = S.getTransform = function (a, c, d, e) { if (a._gsTransform && d && !e)
            return a._gsTransform; var f, h, i, j, k, l, m = d ? a._gsTransform || new Ga : new Ga, n = m.scaleX < 0, o = 2e-5, p = 1e5, q = Fa ? parseFloat(_(a, Ea, c, !1, "0 0 0").split(" ")[2]) || m.zOrigin || 0 : 0, r = parseFloat(g.defaultTransformPerspective) || 0; if (m.svg = !(!a.getCTM || !Oa(a)), m.svg && (La(a, _(a, Ea, c, !1, "50% 50%") + "", m, a.getAttribute("data-svg-origin")), Aa = g.useSVGTransformAttr || Ka), f = Qa(a), f !== Pa) {
            if (16 === f.length) {
        ...
        j = Ga.prototype, j.x = j.y = j.z = j.skewX = j.skewY = j.rotation = j.rotationX = j.rotationY = j.zOrigin = j.xPercent = j.yPercent = j.xOffset = j.yOffset = 0, j.scaleX = j.scaleY = j.scaleZ = 1, ya("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", { parser: function (a, b, c, d, f, h, i) {
            ...
            }, prefix: !0 }), ya("boxShadow", { defaultValue: "0px 0px 0px 0px #999", prefix: !0, color: !0, multi: !0, keyword: "inset" }), ya("borderRadius", { defaultValue: "0px", parser: function (a, b, c, f, g, h) { b = this.format(b); var i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], z = a.style; for (q = parseFloat(a.offsetWidth), r = parseFloat(a.offsetHeight), i = b.split(" "), j = 0; j < y.length; j++)
                this.p.indexOf("border") && (y[j] = Z(y[j])), m = l = _(a, y[j], e, !1, "0px"), -1 !== m.indexOf(" ") && (l = m.split(" "), m = l[0], l = l[1]), n = k = i[j], o = parseFloat(m), t = m.substr((o + "").length), u = "=" === n.charAt(1), u ? (p = parseInt(n.charAt(0) + "1", 10), n = n.substr(2), p *= parseFloat(n), s = n.substr((p + "").length - (0 > p ? 1 : 0)) || "") : (p = parseFloat(n), s = n.substr((p + "").length)), "" === s && (s = d[c] || t), s !== t && (v = aa(a, "borderLeft", o, t), w = aa(a, "borderTop", o, t), "%" === s ? (m = v / q * 100 + "%", l = w / r * 100 + "%") : "em" === s ? (x = aa(a, "borderLeft", 1, "em"), m = v / x + "em", l = w / x + "em") : (m = v + "px", l = w + "px"), u && (n = parseFloat(m) + p + s, k = parseFloat(l) + p + s)), g = va(z, y[j], m + " " + l, n + " " + k, !1, "0px", g); return g; }, prefix: !0, formatter: qa("0px 0px 0px 0px", !1, !0) }), ya("borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius", { defaultValue: "0px", parser: function (a, b, c, d, f, g) { return va(a.style, c, this.format(_(a, c, e, !1, "0px 0px")), this.format(b), !1, "0px", f); }, prefix: !0, formatter: qa("0px 0px", !1, !0) }), ya("backgroundPosition", { defaultValue: "0 0", parser: function (a, b, c, d, f, g) { var h, i, j, k, l, m, n = "background-position", o = e || $(a, null), q = this.format((o ? p ? o.getPropertyValue(n + "-x") + " " + o.getPropertyValue(n + "-y") : o.getPropertyValue(n) : a.currentStyle.backgroundPositionX + " " + a.currentStyle.backgroundPositionY) || "0 0"), r = this.format(b); if (-1 !== q.indexOf("%") != (-1 !== r.indexOf("%")) && r.split(",").length < 2 && (m = _(a, "backgroundImage").replace(D, ""), m && "none" !== m)) {
        ...
        ya("className", { parser: function (a, b, d, f, g, h, i) { var j, k, l, m, n, o = a.getAttribute("class") || "", p = a.style.cssText; if (g = f._classNamePT = new ta(a, d, 0, 0, g, 2), g.setRatio = Wa, g.pr = -11, c = !0, g.b = o, k = ca(a, e), l = a._gsClassPT) {
                for (m = {}, n = l.data; n;)
                    m[n.p] = 1, n = n._next;
                l.setRatio(1);
            } return a._gsClassPT = g, g.e = "=" !== b.charAt(1) ? b : o.replace(new RegExp("(?:\\s|^)" + b.substr(2) + "(?![\\w-])"), "") + ("+" === b.charAt(0) ? " " + b.substr(2) : ""), a.setAttribute("class", g.e), j = da(a, k, ca(a), i, m), a.setAttribute("class", o), g.data = j.firstMPT, a.style.cssText = p, g = g.xfirst = f.parse(a, j.difs, g, h); } });
        var Xa = function (a) { if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
        ...
        for (ya("clearProps", { parser: function (a, b, d, e, f) { return f = new ta(a, d, 0, 0, f, 2), f.setRatio = Xa, f.e = b, f.pr = -10, f.data = e._tween, c = !0, f; } }), j = "bezier,throwProps,physicsProps,physics2D".split(","), wa = j.length; wa--;)
            za(j[wa]);
        j = g.prototype, j._firstPT = j._lastParsedTransform = j._transform = null, j._onInitTween = function (a, b, h, j) { if (!a.nodeType)
        ...
        j._addLazySet = function (a, b, c) { var d = this._firstPT = new ta(a, b, 0, 0, this._firstPT, 2); d.e = c, d.setRatio = Ya, d.data = this; }, j._linkCSSP = function (a, b, c, d) { return a && (b && (b._prev = a), a._next && (a._next._prev = a._prev), a._prev ? a._prev._next = a._next : this._firstPT === a && (this._firstPT = a._next, d = !0), c ? c._next = a : d || null !== this._firstPT || (this._firstPT = a), a._next = b, a._prev = c), a; }, j._mod = function (a) { for (var b = this._firstPT; b;)
            "function" == typeof a[b.p] && a[b.p] === Math.round && (b.r = 1), b = b._next; }, j._kill = function (b) { var c, d, e, f = b; if (b.autoAlpha || b.alpha) {
            f = {};
            for (d in b)
                f[d] = b[d];
        ...
        return g.cascadeTo = function (a, c, d) { var e, f, g, h, i = b.to(a, c, d), j = [i], k = [], l = [], m = [], n = b._internals.reservedProps; for (a = i._targets || i.target, Za(a, k, m), i.render(c, !0, !0), Za(a, l), i.render(0, !0, !0), i._enabled(!0), e = m.length; --e > -1;)
    ...
    }, !0), function () { var a = _gsScope._gsDefine.plugin({ propName: "roundProps", version: "1.6.0", priority: -1, API: 2, init: function (a, b, c) { return this._tween = c, !0; } }), b = function (a) { for (; a;)
        a.f || a.blob || (a.m = Math.round), a = a._next; }, c = a.prototype; c._onInitAllProps = function () { for (var a, c, d, e = this._tween, f = e.vars.roundProps.join ? e.vars.roundProps : e.vars.roundProps.split(","), g = f.length, h = {}, i = e._propLookup.roundProps; --g > -1;)
        ...
        c = o ? Math.random() : 1 / l * n, d = q ? q.getRatio(c) : c, "none" === i ? e = r : "out" === i ? (f = 1 - c, e = f * f * r) : "in" === i ? e = c * c * r : .5 > c ? (f = 2 * c, e = f * f * .5 * r) : (f = 2 * (1 - c), e = f * f * .5 * r), o ? d += Math.random() * e - .5 * e : n % 2 ? d += .5 * e : d -= .5 * e, p && (d > 1 ? d = 1 : 0 > d && (d = 0)), j[k++] = { x: c, y: d }; for (j.sort(function (a, b) { return a.x - b.x; }), h = new m(1, 1, null), n = l; --n > -1;)
        g = j[n], h = new m(g.x, g.y, h); this._prev = new m(0, 0, 0 !== h.t ? h : h.next); }, !0), q = c.prototype = new a, q.constructor = c, q.getRatio = function (a) { var b = this._prev; if (a > b.t) {
        for (; b.next && a >= b.t;)
            b = b.next;
        b = b.prev;
    }
        ...
        for (; b.prev && a <= b.t;)
            b = b.prev; return this._prev = b, b.v + (a - b.t) / b.gap * b.c; }, q.config = function (a) { return new c(a); }, c.ease = new c, l("Bounce", j("BounceOut", function (a) { return 1 / 2.75 > a ? 7.5625 * a * a : 2 / 2.75 > a ? 7.5625 * (a -= 1.5 / 2.75) * a + .75 : 2.5 / 2.75 > a ? 7.5625 * (a -= 2.25 / 2.75) * a + .9375 : 7.5625 * (a -= 2.625 / 2.75) * a + .984375; }), j("BounceIn", function (a) { return (a = 1 - a) < 1 / 2.75 ? 1 - 7.5625 * a * a : 2 / 2.75 > a ? 1 - (7.5625 * (a -= 1.5 / 2.75) * a + .75) : 2.5 / 2.75 > a ? 1 - (7.5625 * (a -= 2.25 / 2.75) * a + .9375) : 1 - (7.5625 * (a -= 2.625 / 2.75) * a + .984375); }), j("BounceInOut", function (a) { var b = .5 > a; return a = b ? 1 - 2 * a : 2 * a - 1, a = 1 / 2.75 > a ? 7.5625 * a * a : 2 / 2.75 > a ? 7.5625 * (a -= 1.5 / 2.75) * a + .75 : 2.5 / 2.75 > a ? 7.5625 * (a -= 2.25 / 2.75) * a + .9375 : 7.5625 * (a -= 2.625 / 2.75) * a + .984375, b ? .5 * (1 - a) : .5 * a + .5; })), l("Circ", j("CircOut", function (a) { return Math.sqrt(1 - (a -= 1) * a); }), j("CircIn", function (a) { return -(Math.sqrt(1 - a * a) - 1); }), j("CircInOut", function (a) { return (a *= 2) < 1 ? -.5 * (Math.sqrt(1 - a * a) - 1) : .5 * (Math.sqrt(1 - (a -= 2) * a) + 1); })), d = function (b, c, d) { var e = i("easing." + b, function (a, b) { this._p1 = a >= 1 ? a : 1, this._p2 = (b || d) / (1 > a ? a : 1), this._p3 = this._p2 / g * (Math.asin(1 / this._p1) || 0), this._p2 = g / this._p2; }, !0), f = e.prototype = new a; return f.constructor = e, f.getRatio = c, f.config = function (a, b) { return new e(a, b); }, e; }, l("Elastic", d("ElasticOut", function (a) { return this._p1 * Math.pow(2, -10 * a) * Math.sin((a - this._p3) * this._p2) + 1; }, .3), d("ElasticIn", function (a) { return -(this._p1 * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - this._p3) * this._p2)); }, .3), d("ElasticInOut", function (a) { return (a *= 2) < 1 ? -.5 * (this._p1 * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - this._p3) * this._p2)) : this._p1 * Math.pow(2, -10 * (a -= 1)) * Math.sin((a - this._p3) * this._p2) * .5 + 1; }, .45)), l("Expo", j("ExpoOut", function (a) { return 1 - Math.pow(2, -10 * a); }), j("ExpoIn", function (a) { return Math.pow(2, 10 * (a - 1)) - .001; }), j("ExpoInOut", function (a) { return (a *= 2) < 1 ? .5 * Math.pow(2, 10 * (a - 1)) : .5 * (2 - Math.pow(2, -10 * (a - 1))); })), l("Sine", j("SineOut", function (a) { return Math.sin(a * h); }), j("SineIn", function (a) { return -Math.cos(a * h) + 1; }), j("SineInOut", function (a) { return -.5 * (Math.cos(Math.PI * a) - 1); })), i("easing.EaseLookup", { find: function (b) { return a.map[b]; } }, !0), k(e.SlowMo, "SlowMo", "ease,"), k(c, "RoughEase", "ease,"), k(b, "SteppedEase", "ease,"), o; }, !0);
}), _gsScope._gsDefine && _gsScope._gsQueue.pop()(), function (a, b) {
    "use strict";
    var c = {}, d = a.document, e = a.GreenSockGlobals = a.GreenSockGlobals || a;
    if (!e.TweenLite) {
        var f, g, h, i, j, k = function (a) { var b, c = a.split("."), d = e; for (b = 0; b < c.length; b++)
            d[c[b]] = d = d[c[b]] || {}; return d; }, l = k("com.greensock"), m = 1e-10, n = function (a) { var b, c = [], d = a.length; for (b = 0; b !== d; c.push(a[b++]))
            ; return c; }, o = function () { }, p = function () { var a = Object.prototype.toString, b = a.call([]); return function (c) { return null != c && (c instanceof Array || "object" == typeof c && !!c.push && a.call(c) === b); }; }(), q = {}, r = function (d, f, g, h) { this.sc = q[d] ? q[d].sc : [], q[d] = this, this.gsClass = null, this.func = g; var i = []; this.check = function (j) { for (var l, m, n, o, p = f.length, s = p; --p > -1;)
            (l = q[f[p]] || new r(f[p], [])).gsClass ? (i[p] = l.gsClass, s--) : j && l.sc.push(this); if (0 === s && g) {
            if (m = ("com.greensock." + d).split("."), n = m.pop(), o = k(m.join("."))[n] = this.gsClass = g.apply(g, i), h)
                if (e[n] = c[n] = o, "undefined" != typeof module && module.exports)
                    ...
                    "function" == "function" && __webpack_require__(12) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () { return o; }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
            for (p = 0; p < this.sc.length; p++)
                this.sc[p].check();
        } }, this.check(!0); }, s = a._gsDefine = function (a, b, c, d) { return new r(a, b, c, d); }, t = l._class = function (a, b, c) { return b = b || function () { }, s(a, [], function () { return b; }, c), b; };
        s.globals = e;
        var u = [0, 0, 1, 1], v = t("easing.Ease", function (a, b, c, d) { this._func = a, this._type = c || 0, this._power = d || 0, this._params = b ? u.concat(b) : u; }, !0), w = v.map = {}, x = v.register = function (a, b, c, d) { for (var e, f, g, h, i = b.split(","), j = i.length, k = (c || "easeIn,easeOut,easeInOut").split(","); --j > -1;)
            for (f = i[j], e = d ? t("easing." + f, null, !0) : l.easing[f] || {}, g = k.length; --g > -1;)
                h = k[g], w[f + "." + h] = w[h + f] = e[h] = a.getRatio ? a : a[h] || new a; };
        for (h = v.prototype, h._calcEnd = !1, h.getRatio = function (a) { if (this._func)
            return this._params[0] = a, this._func.apply(null, this._params); var b = this._type, c = this._power, d = 1 === b ? 1 - a : 2 === b ? a : .5 > a ? 2 * a : 2 * (1 - a); return 1 === c ? d *= d : 2 === c ? d *= d * d : 3 === c ? d *= d * d * d : 4 === c && (d *= d * d * d * d), 1 === b ? 1 - d : 2 === b ? d : .5 > a ? d / 2 : 1 - d / 2; }, f = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"], g = f.length; --g > -1;)
        ...
        h = y.prototype, h.addEventListener = function (a, b, c, d, e) { e = e || 0; var f, g, h = this._listeners[a], k = 0; for (this !== i || j || i.wake(), null == h && (this._listeners[a] = h = []), g = h.length; --g > -1;)
            f = h[g], f.c === b && f.s === c ? h.splice(g, 1) : 0 === k && f.pr < e && (k = g + 1); h.splice(k, 0, { c: b, s: c, up: d, pr: e }); }, h.removeEventListener = function (a, b) { var c, d = this._listeners[a]; if (d)
            for (c = d.length; --c > -1;)
                if (d[c].c === b)
                    return void d.splice(c, 1); }, h.dispatchEvent = function (a) { var b, c, d, e = this._listeners[a]; if (e)
            for (b = e.length, b > 1 && (e = e.slice(0)), c = this._eventTarget; --b > -1;)
                d = e[b], d && (d.up ? d.c.call(d.s || c, { type: a, target: c }) : d.c.call(d.s || c)); };
        var z = a.requestAnimationFrame, A = a.cancelAnimationFrame, B = Date.now || function () { return (new Date).getTime(); }, C = B();
        ...
        var D = t("core.Animation", function (a, b) { if (this.vars = b = b || {}, this._duration = this._totalDuration = a || 0, this._delay = Number(b.delay) || 0, this._timeScale = 1, this._active = b.immediateRender === !0, this.data = b.data, this._reversed = b.reversed === !0, X) {
            j || i.wake();
            var c = this.vars.useFrames ? W : X;
            c.add(this, c._time), this.vars.paused && this.paused(!0);
        } });
        i = D.ticker = new l.Ticker, h = D.prototype, h._dirty = h._gc = h._initted = h._paused = !1, h._totalTime = h._time = 0, h._rawPrevTime = -1, h._next = h._last = h._onUpdate = h._timeline = h.timeline = null, h._paused = !1;
        var E = function () { j && B() - C > 2e3 && "hidden" !== d.visibilityState && i.wake(); var a = setTimeout(E, 2e3); a.unref && a.unref(); };
        E(), h.play = function (a, b) { return null != a && this.seek(a, b), this.reversed(!1).paused(!1); }, h.pause = function (a, b) { return null != a && this.seek(a, b), this.paused(!0); }, h.resume = function (a, b) { return null != a && this.seek(a, b), this.paused(!1); }, h.seek = function (a, b) { return this.totalTime(Number(a), b !== !1); }, h.restart = function (a, b) { return this.reversed(!1).paused(!1).totalTime(a ? -this._delay : 0, b !== !1, !0); }, h.reverse = function (a, b) { return null != a && this.seek(a || this.totalDuration(), b), this.reversed(!0).paused(!1); }, h.render = function (a, b, c) { }, h.invalidate = function () { return this._time = this._totalTime = 0, this._initted = this._gc = !1, this._rawPrevTime = -1, (this._gc || !this.timeline) && this._enabled(!0), this; }, h.isActive = function () { var a, b = this._timeline, c = this._startTime; return !b || !this._gc && !this._paused && b.isActive() && (a = b.rawTime(!0)) >= c && a < c + this.totalDuration() / this._timeScale - 1e-7; }, h._enabled = function (a, b) { return j || i.wake(), this._gc = !a, this._active = this.isActive(), b !== !0 && (a && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !a && this.timeline && this._timeline._remove(this, !0)), !1; }, h._kill = function (a, b) { return this._enabled(!1, !1); }, h.kill = function (a, b) { return this._kill(a, b), this; }, h._uncache = function (a) { for (var b = a ? this : this.timeline; b;)
            b._dirty = !0, b = b.timeline; return this; }, h._swapSelfInParams = function (a) { for (var b = a.length, c = a.concat(); --b > -1;)
            "{self}" === a[b] && (c[b] = this); return c; }, h._callback = function (a) { var b = this.vars, c = b[a], d = b[a + "Params"], e = b[a + "Scope"] || b.callbackScope || this, f = d ? d.length : 0; switch (f) {
            case 0:
                c.call(e);
                break;
            case 1:
        ...
        } return this; }, h.progress = h.totalProgress = function (a, b) { var c = this.duration(); return arguments.length ? this.totalTime(c * a, b) : c ? this._time / c : this.ratio; }, h.startTime = function (a) { return arguments.length ? (a !== this._startTime && (this._startTime = a, this.timeline && this.timeline._sortChildren && this.timeline.add(this, a - this._delay)), this) : this._startTime; }, h.endTime = function (a) { return this._startTime + (0 != a ? this.totalDuration() : this.duration()) / this._timeScale; }, h.timeScale = function (a) { if (!arguments.length)
            return this._timeScale; if (a = a || m, this._timeline && this._timeline.smoothChildTiming) {
            var b = this._pauseTime, c = b || 0 === b ? b : this._timeline.totalTime();
            this._startTime = c - (c - this._startTime) * this._timeScale / a;
        } return this._timeScale = a, this._uncache(!1); }, h.reversed = function (a) { return arguments.length ? (a != this._reversed && (this._reversed = a, this.totalTime(this._timeline && !this._timeline.smoothChildTiming ? this.totalDuration() - this._totalTime : this._totalTime, !0)), this) : this._reversed; }, h.paused = function (a) { if (!arguments.length)
            return this._paused; var b, c, d = this._timeline; return a != this._paused && d && (j || a || i.wake(), b = d.rawTime(), c = b - this._pauseTime, !a && d.smoothChildTiming && (this._startTime += c, this._uncache(!1)), this._pauseTime = a ? b : null, this._paused = a, this._active = this.isActive(), !a && 0 !== c && this._initted && this.duration() && (b = d.smoothChildTiming ? this._totalTime : (b - this._startTime) / this._timeScale, this.render(b, b === this._totalTime, !0))), this._gc && !a && this._enabled(!0, !1), this; };
        ...
        }, h._remove = function (a, b) { return a.timeline === this && (b || a._enabled(!1, !0), a._prev ? a._prev._next = a._next : this._first === a && (this._first = a._next), a._next ? a._next._prev = a._prev : this._last === a && (this._last = a._prev), a._next = a._prev = a.timeline = null, a === this._recent && (this._recent = this._last), this._timeline && this._uncache(!0)), this; }, h.render = function (a, b, c) { var d, e = this._first; for (this._totalTime = this._time = this._rawPrevTime = a; e;)
            d = e._next, (e._active || a >= e._startTime && !e._paused && !e._gc) && (e._reversed ? e.render((e._dirty ? e.totalDuration() : e._totalDuration) - (a - e._startTime) * e._timeScale, b, c) : e.render((a - e._startTime) * e._timeScale, b, c)), e = d; }, h.rawTime = function () { return j || i.wake(), this._totalTime; };
        var G = t("TweenLite", function (b, c, d) { if (D.call(this, c, d), this.render = G.prototype.render, null == b)
            throw "Cannot tween a null target."; this.target = b = "string" != typeof b ? b : G.selector(b) || b; var e, f, g, h = b.jquery || b.length && b !== a && b[0] && (b[0] === a || b[0].nodeType && b[0].style && !b.nodeType), i = this.vars.overwrite; if (this._overwrite = i = null == i ? V[G.defaultOverwrite] : "number" == typeof i ? i >> 0 : V[i], (h || b instanceof Array || b.push && p(b)) && "number" != typeof b[0])
            ...
            U[c] || c in b && "transform" !== c && "x" !== c && "y" !== c && "width" !== c && "height" !== c && "className" !== c && "border" !== c || !(!R[c] || R[c] && R[c]._autoCSS) || (d[c] = a[c], delete a[c]); a.css = d; };
        ...
        var J = [], K = {}, L = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, M = /[\+-]=-?[\.\d]/, N = function (a) { for (var b, c = this._firstPT, d = 1e-6; c;)
            b = c.blob ? 1 === a && this.end ? this.end : a ? this.join("") : this.start : c.c * a + c.s, c.m ? b = c.m(b, this._target || c.t) : d > b && b > -d && !c.blob && (b = 0), c.f ? c.fp ? c.t[c.p](c.fp, b) : c.t[c.p](b) : c.t[c.p] = b, c = c._next; }, O = function (a, b, c, d) { var e, f, g, h, i, j, k, l = [], m = 0, n = "", o = 0; for (l.start = a, l.end = b, a = l[0] = a + "", b = l[1] = b + "", c && (c(l), a = l[0], b = l[1]), l.length = 0, e = a.match(L) || [], f = b.match(L) || [], d && (d._next = null, d.blob = 1, l._firstPT = l._applyPT = d), i = f.length, h = 0; i > h; h++)
            k = f[h], j = b.substr(m, b.indexOf(k, m) - m), n += j || !h ? j : ",", m += j.length, o ? o = (o + 1) % 5 : "rgba(" === j.substr(-5) && (o = 1), k === e[h] || e.length <= h ? n += k : (n && (l.push(n), n = ""), g = parseFloat(e[h]), l.push(g), l._firstPT = { _next: l._firstPT, t: l, p: l.length - 1, s: g, c: ("=" === k.charAt(1) ? parseInt(k.charAt(0) + "1", 10) * parseFloat(k.substr(2)) : parseFloat(k) - g) || 0, f: 0, m: o && 4 > o ? Math.round : 0 }), m += k.length; return n += b.substr(m), n && l.push(n), l.setRatio = N, M.test(b) && (l.end = 0), l; }, P = function (a, b, c, d, e, f, g, h, i) { "function" == typeof d && (d = d(i || 0, a)); var j, k = typeof a[b], l = "function" !== k ? "" : b.indexOf("set") || "function" != typeof a["get" + b.substr(3)] ? b : "get" + b.substr(3), m = "get" !== c ? c : l ? g ? a[l](g) : a[l]() : a[b], n = "string" == typeof d && "=" === d.charAt(1), o = { t: a, p: b, s: m, f: "function" === k, pg: 0, n: e || b, m: f ? "function" == typeof f ? f : Math.round : 0, pr: 0, c: n ? parseInt(d.charAt(0) + "1", 10) * parseFloat(d.substr(2)) : parseFloat(d) - m || 0 }; return ("number" != typeof m || "number" != typeof d && !n) && (g || isNaN(m) || !n && isNaN(d) || "boolean" == typeof m || "boolean" == typeof d ? (o.fp = g, j = O(m, n ? parseFloat(o.s) + o.c : d, h || G.defaultStringFilter, o), o = { t: j, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: e || b, pr: 0, m: 0 }) : (o.s = parseFloat(m), n || (o.c = parseFloat(d) - o.s || 0))), o.c ? ((o._next = this._firstPT) && (o._next._prev = o), this._firstPT = o, o) : void 0; }, Q = G._internals = { isArray: p, isSelector: H, lazyTweens: J, blobDif: O }, R = G._plugins = {}, S = Q.tweenLookup = {}, T = 0, U = Q.reservedProps = { ease: 1, delay: 1, overwrite: 1, onComplete: 1, onCompleteParams: 1, onCompleteScope: 1, useFrames: 1, runBackwards: 1, startAt: 1, onUpdate: 1, onUpdateParams: 1, onUpdateScope: 1, onStart: 1, onStartParams: 1, onStartScope: 1, onReverseComplete: 1, onReverseCompleteParams: 1, onReverseCompleteScope: 1, onRepeat: 1, onRepeatParams: 1, onRepeatScope: 1, easeParams: 1, yoyo: 1, immediateRender: 1, repeat: 1, repeatDelay: 1, data: 1, paused: 1, reversed: 1, autoCSS: 1, lazy: 1, onOverwrite: 1, callbackScope: 1, stringFilter: 1, id: 1, yoyoEase: 1 }, V = { none: 0, all: 1, auto: 2, concurrent: 3, allOnStart: 4, preexisting: 5, "true": 1, "false": 0 }, W = D._rootFramesTimeline = new F, X = D._rootTimeline = new F, Y = 30, Z = Q.lazyRender = function () { var a, b = J.length; for (K = {}; --b > -1;)
            a = J[b], a && a._lazy !== !1 && (a.render(a._lazy[0], a._lazy[1], !0), a._lazy = !1); J.length = 0; };
        X._startTime = i.time, W._startTime = i.frame, X._active = W._active = !0, setTimeout(Z, 1), D._updateRoot = G.render = function () { var a, b, c; if (J.length && Z(), X.render((i.time - X._startTime) * X._timeScale, !1, !1), W.render((i.frame - W._startTime) * W._timeScale, !1, !1), J.length && Z(), i.frame >= Y) {
        ...
        var $ = function (a, b, c) { var d, e, f = a._gsTweenID; if (S[f || (a._gsTweenID = f = "t" + T++)] || (S[f] = { target: a, tweens: [] }), b && (d = S[f].tweens, d[e = d.length] = b, c))
            for (; --e > -1;)
                d[e] === b && d.splice(e, 1); return S[f].tweens; }, _ = function (a, b, c, d) { var e, f, g = a.vars.onOverwrite; return g && (e = g(a, b, c, d)), g = G.onOverwrite, g && (f = g(a, b, c, d)), e !== !1 && f !== !1; }, aa = function (a, b, c, d, e) { var f, g, h, i; if (1 === d || d >= 4) {
            for (i = e.length, f = 0; i > f; f++)
                if ((h = e[f]) !== b)
                    ...
                    break;
            return g;
        } var j, k = b._startTime + m, l = [], n = 0, o = 0 === b._duration; for (f = e.length; --f > -1;)
            (h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (j = j || ba(b, 0, o), 0 === ba(h, j, o) && (l[n++] = h)) : h._startTime <= k && h._startTime + h.totalDuration() / h._timeScale > k && ((o || !h._initted) && k - h._startTime <= 2e-10 || (l[n++] = h))); for (f = n; --f > -1;)
            if (h = l[f], 2 === d && h._kill(c, a, b) && (g = !0), 2 !== d || !h._firstPT && h._initted) {
                if (2 !== d && !_(h, b))
                    continue;
                h._enabled(!1, !1) && (g = !0);
            } return g; }, ba = function (a, b, c) { for (var d = a._timeline, e = d._timeScale, f = a._startTime; d._timeline;) {
            if (f += d._startTime, e *= d._timeScale, d._paused)
                return -100;
            d = d._timeline;
        } return f /= e, f > b ? f - b : c && f === b || !a._initted && 2 * m > f - b ? m : (f += a.totalDuration() / a._timeScale / e) > b + m ? 0 : f - b - m; };
        h._init = function () { var a, b, c, d, e, f, g = this.vars, h = this._overwrittenProps, i = this._duration, j = !!g.immediateRender, k = g.ease; if (g.startAt) {
            ...
            b = this._initProps(this.target, this._propLookup, this._siblings, h, 0); if (b && G._onPluginEvent("_onInitAllProps", this), h && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), g.runBackwards)
            for (c = this._firstPT; c;)
                c.s += c.c, c.c = -c.c, c = c._next; this._onUpdate = g.onUpdate, this._initted = !0; }, h._initProps = function (b, c, d, e, f) { var g, h, i, j, k, l; if (null == b)
            return !1; K[b._gsTweenID] && Z(), this.vars.css || b.style && b !== a && b.nodeType && R.css && this.vars.autoCSS !== !1 && I(this.vars, b); for (g in this.vars)
            if (l = this.vars[g], U[g])
                ...
                c[g] = P.call(this, b, g, "get", l, g, 0, null, this.vars.stringFilter, f); return e && this._kill(e, b) ? this._initProps(b, c, d, e, f) : this._overwrite > 1 && this._firstPT && d.length > 1 && aa(b, this, c, this._overwrite, d) ? (this._kill(c, b), this._initProps(b, c, d, e, f)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (K[b._gsTweenID] = !0), i); }, h.render = function (a, b, c) { var d, e, f, g, h = this._time, i = this._duration, j = this._rawPrevTime; if (a >= i - 1e-7 && a >= 0)
        ...
        } }, h._kill = function (a, b, c) { if ("all" === a && (a = null), null == a && (null == b || b === this.target))
            return this._lazy = !1, this._enabled(!1, !1); b = "string" != typeof b ? b || this._targets || this.target : G.selector(b) || b; var d, e, f, g, h, i, j, k, l, m = c && this._time && c._startTime === this._startTime && this._timeline === c._timeline; if ((p(b) || H(b)) && "number" != typeof b[0])
            for (d = b.length; --d > -1;)
        ...
        } return D.prototype._enabled.call(this, a, b), this._notifyPluginsOfEnabled && this._firstPT ? G._onPluginEvent(a ? "_onEnable" : "_onDisable", this) : !1; }, G.to = function (a, b, c) { return new G(a, b, c); }, G.from = function (a, b, c) { return c.runBackwards = !0, c.immediateRender = 0 != c.immediateRender, new G(a, b, c); }, G.fromTo = function (a, b, c, d) { return d.startAt = c, d.immediateRender = 0 != d.immediateRender && 0 != c.immediateRender, new G(a, b, d); }, G.delayedCall = function (a, b, c, d, e) { return new G(b, 0, { delay: a, onComplete: b, onCompleteParams: c, callbackScope: d, onReverseComplete: b, onReverseCompleteParams: c, immediateRender: !1, lazy: !1, useFrames: e, overwrite: 0 }); }, G.set = function (a, b) { return new G(a, 0, b); }, G.getTweensOf = function (a, b) { if (null == a)
            return []; a = "string" != typeof a ? a : G.selector(a) || a; var c, d, e, f; if ((p(a) || H(a)) && "number" != typeof a[0]) {
            ...
            for (d = $(a).concat(), c = d.length; --c > -1;)
                (d[c]._gc || b && !d[c].isActive()) && d.splice(c, 1); return d || []; }, G.killTweensOf = G.killDelayedCallsTo = function (a, b, c) { "object" == typeof b && (c = b, b = !1); for (var d = G.getTweensOf(a, b), e = d.length; --e > -1;)
            d[e]._kill(c, a); };
        ...
        if (h = ca.prototype, ca.version = "1.19.0", ca.API = 2, h._firstPT = null, h._addTween = P, h.setRatio = N, h._kill = function (a) { var b, c = this._overwriteProps, d = this._firstPT; if (null != a[this._propName])
            this._overwriteProps = [];
        else
            for (b = c.length; --b > -1;)
                null != a[c[b]] && c.splice(b, 1); for (; d;)
            null != a[d.n] && (d._next && (d._next._prev = d._prev), d._prev ? (d._prev._next = d._next, d._prev = null) : this._firstPT === d && (this._firstPT = d._next)), d = d._next; return !1; }, h._mod = h._roundProps = function (a) { for (var b, c = this._firstPT; c;)
            b = a[this._propName] || null != c.n && a[c.n.split(this._propName + "_").join("")], b && "function" == typeof b && (2 === c.f ? c.t._applyPT.m = b : c.m = b), c = c._next; }, G._onPluginEvent = function (a, b) { var c, d, e, f, g, h = b._firstPT; if ("_onInitAllProps" === a) {
            for (; h;) {
            ...
            h.pg && "function" == typeof h.t[a] && h.t[a]() && (c = !0), h = h._next; return c; }, ca.activate = function (a) { for (var b = a.length; --b > -1;)
            a[b].API === ca.API && (R[(new a[b])._propName] = a[b]); return !0; }, s.plugin = function (a) { if (!(a && a.propName && a.init && a.API))
            throw "illegal plugin definition."; var b, c = a.propName, d = a.priority || 0, e = a.overwriteProps, f = { init: "_onInitTween", set: "setRatio", kill: "_kill", round: "_mod", mod: "_mod", initAll: "_onInitAllProps" }, g = t("plugins." + c.charAt(0).toUpperCase() + c.substr(1) + "Plugin", function () { ca.call(this, c, d), this._overwriteProps = e || []; }, a.global === !0), h = g.prototype = new ca(c); h.constructor = g, g.API = a.API; for (b in f)
            "function" == typeof a[b] && (h[f[b]] = a[b]); return g.version = a.version, ca.activate([g]), g; }, f = a._gsQueue) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    "use strict";
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (a) { var b, c, d, e = _gsScope.GreenSockGlobals || _gsScope, f = e.com.greensock, g = 2 * Math.PI, h = Math.PI / 2, i = f._class, j = function (b, c) { var d = i("easing." + b, function () { }, !0), e = d.prototype = new a; return e.constructor = d, e.getRatio = c, d; }, k = a.register || function () { }, l = function (a, b, c, d, e) { var f = i("easing." + a, { easeOut: new b, easeIn: new c, easeInOut: new d }, !0); return k(f, a), f; }, m = function (a, b, c) { this.t = a, this.v = b, c && (this.next = c, c.prev = this, this.c = c.v - b, this.gap = c.t - a); }, n = function (b, c) { var d = i("easing." + b, function (a) { this._p1 = a || 0 === a ? a : 1.70158, this._p2 = 1.525 * this._p1; }, !0), e = d.prototype = new a; return e.constructor = d, e.getRatio = c, e.config = function (a) { return new d(a); }, d; }, o = l("Back", n("BackOut", function (a) { return (a -= 1) * a * ((this._p1 + 1) * a + this._p1) + 1; }), n("BackIn", function (a) { return a * a * ((this._p1 + 1) * a - this._p1); }), n("BackInOut", function (a) { return (a *= 2) < 1 ? .5 * a * a * ((this._p2 + 1) * a - this._p2) : .5 * ((a -= 2) * a * ((this._p2 + 1) * a + this._p2) + 2); })), p = i("easing.SlowMo", function (a, b, c) { b = b || 0 === b ? b : .7, null == a ? a = .7 : a > 1 && (a = 1), this._p = 1 !== a ? b : 0, this._p1 = (1 - a) / 2, this._p2 = a, this._p3 = this._p1 + this._p2, this._calcEnd = c === !0; }, !0), q = p.prototype = new a; return q.constructor = p, q.getRatio = function (a) { var b = a + (.5 - a) * this._p; return a < this._p1 ? this._calcEnd ? 1 - (a = 1 - a / this._p1) * a : b - (a = 1 - a / this._p1) * a * a * a * b : a > this._p3 ? this._calcEnd ? 1 - (a = (a - this._p3) / this._p1) * a : b + (a - b) * (a = (a - this._p3) / this._p1) * a * a * a : this._calcEnd ? 1 : b; }, p.ease = new p(.7, .7), q.config = p.config = function (a, b, c) { return new p(a, b, c); }, b = i("easing.SteppedEase", function (a, b) { a = a || 1, this._p1 = 1 / a, this._p2 = a + (b ? 0 : 1), this._p3 = b ? 1 : 0; }, !0), q = b.prototype = new a, q.constructor = b, q.getRatio = function (a) { return 0 > a ? a = 0 : a >= 1 && (a = .999999999), ((this._p2 * a | 0) + this._p3) * this._p1; }, q.config = b.config = function (a, c) { return new b(a, c); }, c = i("easing.RoughEase", function (b) { b = b || {}; for (var c, d, e, f, g, h, i = b.taper || "none", j = [], k = 0, l = 0 | (b.points || 20), n = l, o = b.randomize !== !1, p = b.clamp === !0, q = b.template instanceof a ? b.template : null, r = "number" == typeof b.strength ? .4 * b.strength : .4; --n > -1;)
        c = o ? Math.random() : 1 / l * n, d = q ? q.getRatio(c) : c, "none" === i ? e = r : "out" === i ? (f = 1 - c, e = f * f * r) : "in" === i ? e = c * c * r : .5 > c ? (f = 2 * c, e = f * f * .5 * r) : (f = 2 * (1 - c), e = f * f * .5 * r), o ? d += Math.random() * e - .5 * e : n % 2 ? d += .5 * e : d -= .5 * e, p && (d > 1 ? d = 1 : 0 > d && (d = 0)), j[k++] = { x: c, y: d }; for (j.sort(function (a, b) { return a.x - b.x; }), h = new m(1, 1, null), n = l; --n > -1;)
        g = j[n], h = new m(g.x, g.y, h); this._prev = new m(0, 0, 0 !== h.t ? h : h.next); }, !0), q = c.prototype = new a, q.constructor = c, q.getRatio = function (a) { var b = this._prev; if (a > b.t) {
        for (; b.next && a >= b.t;)
            b = b.next;
    ...
    "undefined" != typeof module && module.exports ? (module.exports = a()) : "function" == "function" && __webpack_require__(12) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
 ...
 * 盒子模型碰撞检测
 */
var BoxCollisionDetector = /** @class */ (function () {
    function BoxCollisionDetector() {
    }
    /**
     * 碰撞检测线程方法
     *
     ...
     */
    BoxCollisionDetector.prototype.thread_detectCollision = function (e) {
        var data = JSON.parse(e.data);
        var mapData = data.mapData;
        var mapColMin = data.mapColMin;
        var mapColMax = data.mapColMax;
        var mapRowMin = data.mapRowMin;
        var mapRowMax = data.mapRowMax;
        var collision = []; //记录所有碰撞的坐标点
        var minRow; //最小碰撞行数
        var minCol; //最小碰撞列数
        var maxRow; //最大碰撞行数
        var maxCol; //最大碰撞列数
        for (var row = mapRowMin; row <= mapRowMax; row++) {
            for (var col = mapColMin; col <= mapColMax; col++) {
     ...
     */
    BoxCollisionDetector.prototype.detectCollision = function (com, sx, sy, thread, fixCoor) {
        var $this = com;
        var promise = new promise_1.default();
        if (!($this.parent instanceof map_1.default)) {
            promise.resolve();
            return promise;
        }
        if (sx > $this.parent.getWidth() || sy > $this.parent.getHeight()
            || sx + $this.getWidth() < 0 || sy + $this.getHeight() < 0) {
            promise.resolve();
            return promise;
        }
        ...
        var mapColMin = Math.floor(sx / $this.parent.mapSize);
        var mapColMax = Math.floor((sx + $this.getWidth()) / $this.parent.mapSize);
        if ((sx + $this.getWidth()) % $this.parent.mapSize === 0) {
            mapColMax--;
        }
        var mapRowMin = Math.floor(sy / $this.parent.mapSize);
        var mapRowMax = Math.floor((sy + $this.getHeight()) / $this.parent.mapSize);
        ...
        thread.run({
            ...
            if (typeof (data) === "number" && data === 0) {
                ...
                //修复坐标
                if (fixCoor) {
                    var collisionsArr = JSON.parse(data);
                    var minRow = collisionsArr[0];
                    var maxRow = collisionsArr[1];
                    var minCol = collisionsArr[2];
                    var maxCol = collisionsArr[3];
                    if (maxRow - minRow > maxCol - minCol) {
                        if (mapColMax - minCol > minCol - mapColMin) {
                            $this.setX(maxCol * $this.parent.mapSize + parseInt($this.parent.mapSize.toString()));
                        }
                        else {
                        ...
                        if (mapRowMax - minRow < minRow - mapRowMin) {
                            $this.setY(minRow * $this.parent.mapSize - $this.getHeight());
                        }
                        else {
                            $this.setY(maxRow * $this.parent.mapSize + parseInt($this.parent.mapSize.toString()));
                        }
                    }
                }
                promise.reject(data);
...
exports.default = BoxCollisionDetector;
...
var DragEvent = /** @class */ (function (_super) {
    ...
    DragEvent.prototype.setPageX = function (x) {
        this.pageX = x;
    };
    DragEvent.prototype.setPageY = function (y) {
        this.pageY = y;
    };
    return DragEvent;
}(event_1.default));
...
Object.defineProperty(exports, "__esModule", { value: true });
var eventListener_1 = __webpack_require__(29);
var clickEvent_1 = __webpack_require__(30);
var mouseEvent_1 = __webpack_require__(31);
var keyEvent_1 = __webpack_require__(32);
var wheelEvent_1 = __webpack_require__(33);
var stack_1 = __webpack_require__(34);
var eventNotify_1 = __webpack_require__(35);
var globalUtil_1 = __webpack_require__(1);
var component_1 = __webpack_require__(7);
var controller_1 = __webpack_require__(19);
var EventBus = /** @class */ (function () {
    ...
    EventBus.prototype.addEventListener = function (dom, type, callback) {
     ...
     * @return 批次号（时间戳）
     */
    EventBus.prototype.createPropagationStack = function () {
        var batchNo = (new Date).getTime();
        this.propagationEventQueue[batchNo] = new stack_1.default();
        return batchNo;
    };
    /** 创建鼠标事件通知 */
    EventBus.prototype.createEventNotify = function (e, type) {
        var _this = this;
    ...
    /** 创建非鼠标事件通知 */
    EventBus.prototype.createOtherEventNotify = function (e, type, ntype) {
        var _this = this;
        if (!this.eventListeners[type]) {
            return;
        }
        ...
        var eventNotify;
        this.eventNotifyQueue.push(function () {
            _this.eventListeners[type].forEach(function (listener) {
                if (listener.target.isViewState || listener.target.active) {
                    eventNotify = new eventNotify_1.default();
                    eventNotify.set({
                        batchNo: batchNo,
    ...
    //通知触发事件
    EventBus.prototype.doNotifyEvent = function () {
    ...
    //捕获事件
    EventBus.prototype.captureEvent = function (eventNotify) {
     ...
     * 冒泡执行事件
     */
    EventBus.prototype.propagationEvent = function () {
        var eventNotify;
        var bubble; //上一个冒泡节点
        var target;
        var event;
        ...
        for (key in this.propagationEventQueue) {
            ...
            while (eventNotify = this.propagationEventQueue[key].pop()) {
                if (eventNotify.listener.target.isViewState || !bubble //viewstate节点或第一个节点
                    ...
                    || (event && event.propagation && eventNotify.listener.target.parentOf(bubble))) {
    ...
    EventBus.prototype.getEvent = function (eventNotify) {
        var event;
        switch (eventNotify.listener.type) {
            case "click":
                event = new clickEvent_1.default(eventNotify.listener.type);
                ...
                break;
            case "mousedown":
                event = new mouseEvent_1.default(eventNotify.listener.type);
                event.setCurrentTarget(eventNotify.listener.target);
                if (eventNotify.sourceEvent) {
            ...
            case "mouseup":
                ...
                break;
            case "keydown":
                event = new keyEvent_1.default(eventNotify.listener.type);
                event.setCurrentTarget(eventNotify.listener.target);
                if (eventNotify.sourceEvent) {
            ...
            case "keyup":
                ...
                break;
            case "mousewheel":
                event = new wheelEvent_1.default(eventNotify.listener.type);
                event.setCurrentTarget(eventNotify.listener.target);
                if (eventNotify.sourceEvent) {
     ...
     */
    EventBus.prototype.broadcastEvent = function (type, event, toChildren) {
        var _this = this;
        if (!this.eventListeners[type]) {
            return;
        }
        this.eventListeners[type].forEach(function (listener) {
            if (listener.callback && typeof (listener.callback) === "function") {
                ...
                if (!event || !event.currentTarget) {
                    ...
                    var currentTargetCom = _this.getComponentByTarget(event.currentTarget);
                    var targetCom = _this.getComponentByTarget(listener.target);
     ...
     */
    EventBus.prototype.getComponentByTarget = function (target) {
        var targetCom;
        if (target instanceof component_1.default) {
            targetCom = target;
        }
        else if (target instanceof controller_1.default) {
     ...
     * @param com 绑定事件的组件
     */
    EventBus.prototype.triggerEvent = function (type, com) {
        var eventNotify = new eventNotify_1.default();
        eventNotify.set({
            type: type,
            listener: {
                type: type,
        ...
        var event = this.getEvent(eventNotify);
        this.broadcastEvent(type, event);
    };
    /** 注册事件 */
    EventBus.prototype.registerEvent = function (com, type, callback) {
     ...
     */
    EventBus.prototype.removeEvent = function (com, type, callback) {
    ...
    EventBus.prototype.removeAllEvent = function (com) {
        for (var type in this.eventListeners) {
            this.removeEvent(com, type);
        }
    };
    EventBus.prototype.getEventListener = function (target, type, callback) {
        var eventListener = new eventListener_1.default(type, callback);
...
var MouseEvent = /** @class */ (function (_super) {
    ...
    MouseEvent.prototype.setPageX = function (x) {
        this.pageX = x;
    };
    MouseEvent.prototype.setPageY = function (y) {
        this.pageY = y;
    };
    MouseEvent.prototype.setButton = function (button) {
        this.button = button;
    };
    return MouseEvent;
}(event_1.default));
...
var KeyEvent = /** @class */ (function (_super) {
    ...
    KeyEvent.prototype.setKey = function (key) {
        this.key = key;
    };
...
var WheelEvent = /** @class */ (function (_super) {
    ...
    WheelEvent.prototype.setWheelDelta = function (wheelDelta) {
...
Object.defineProperty(exports, "__esModule", { value: true });
//事件通知类
var EventNotify = /** @class */ (function () {
    function EventNotify() {
    }
    /**
     * 设置通知，下次循环draw的时候用这些值判断是否触发事件
     */
    EventNotify.prototype.set = function (obj) {
 ...
 */
var mainView_js_1 = __webpack_require__(37);
exports.default = {
    id: "mainRoute",
    type: "route",
    routes: {
        "main": {
            view: mainView_js_1.default,
            default: true
        },
        "movement": {
            view: function (get) {
                return new Promise(function (resolve, reject) {
                    __webpack_require__.e/* require.ensure */(1).then((function (require) {
                        get(__webpack_require__(42).default, resolve, reject);
            ...
            view: function (get) {
                return new Promise(function (resolve, reject) {
                    __webpack_require__.e/* require.ensure */(0).then((function (require) {
                        get(__webpack_require__(20).default, resolve, reject);
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                });
            }
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var mainController_1 = __webpack_require__(38);
var childController_js_1 = __webpack_require__(39);
var layoutTestView_js_1 = __webpack_require__(40);
exports.default = {
    controller: mainController_1.default,
    type: "rect",
    style: {
        x: 0,
        y: 0,
    ...
    children: [
        {
            name: "child1",
            controller: childController_js_1.default,
            type: "rect",
            style: {
                x: 10,
                y: 10,
...
var MainController = /** @class */ (function (_super) {
    ...
    function MainController(component) {
        ...
        var thread = new main_1.Thread(_this.testThread);
    ...
    MainController.prototype.testThread = function (e) {
        console.log(e.data);
        self.postMessage("callback");
    };
    MainController.prototype.mouseDown = function (e) {
        console.log("main mouseDown!");
    };
    MainController.prototype.clickMain = function (e) {
        console.log(e);
    };
    MainController.prototype.clickInput = function (e) {
        console.log(e);
        e.stopPropagation();
    };
    MainController.prototype.mousedownInput = function (e) {
        console.log("input mousedown");
    };
    MainController.prototype.changeRoute = function (e) {
        var mainRoute = this.viewState.getComponentById("mainRoute");
        mainRoute.changeRoute("test");
    };
    MainController.prototype.goMovement = function (e) {
        var mainRoute = this.viewState.getComponentById("mainRoute");
        mainRoute.changeRoute("movement", true);
    };
    MainController.prototype.getAllInput = function (e) {
        console.log(this.viewState.getComponentsByName("input"));
        e.stopPropagation();
    };
    MainController.prototype.onClickCheckbox = function (e) {
...
var ChildController = /** @class */ (function (_super) {
    ...
    function ChildController(component) {
        var _this = _super.call(this, component) || this;
        _this.component.registerEvent("mousedown", _this.mousedownPanel.bind(_this, 1));
        _this.component.registerEvent("mousedown", _this.mousedownPanel.bind(_this, 2));
        return _this;
    }
    ChildController.prototype.mousedownPanel = function (num, e) {
        console.log(num);
        //console.log(e);
...
Object.defineProperty(exports, "__esModule", { value: true });
var layoutTestController_js_1 = __webpack_require__(41);
exports.default = {
    type: "rect",
    controller: layoutTestController_js_1.default,
    style: {
        x: 540,
        y: 40,
        width: "40%",
...
Object.defineProperty(exports, "__esModule", { value: true });
var main_1 = __webpack_require__(4);
var LayoutTestController = /** @class */ (function (_super) {
    __extends(LayoutTestController, _super);
    function LayoutTestController(component) {
        return _super.call(this, component) || this;
    }
    LayoutTestController.prototype.clickGreen = function (e) {
        console.log("green");
    };
    LayoutTestController.prototype.removeEvent = function (e) {
        var com = this.viewState.getComponentById("layout_rectGreen");
        com.removeAllEvent();
    };
    return LayoutTestController;
}(main_1.Controller));
exports.default = LayoutTestController;
